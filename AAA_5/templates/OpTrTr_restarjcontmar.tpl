...
<td width="100%" class="nosaltar" style="page-break-inside:void; " >																			
	<table style="border:1px solid #d8d8d8; padding:1; cell-spacing:0; border-collapse:collapse; align:center; width:100%">
	  ...
	  <tr><td colspan=1 class="sinlineas" style="white-space: nowrap;  font-weight:300">OBSERVACIONES:</td>
		...
		<tr>
		  <td colspan=2 style="width:100px; border-bottom: 0px; border-top:0px; border-left0px; "></td>
		...
		<tr>
		  ...
		  <td colspan=2  class="headerrow" style="width:100px; border-bottom: 0px; border-top:0px; border-left:0px; border-right: 1px solid lightgrey;"></td>
...
{report_footer group="txp_Contenedor"}
		<tr >
			<td colspan=2 style="border:1px solid lightgrey; font-weight:bold !important; height=25px; vertical-align:top">SUMA {$rec.txp_Contenedor|upper}</td>
			{foreach key=key item=col from=$aCols}
