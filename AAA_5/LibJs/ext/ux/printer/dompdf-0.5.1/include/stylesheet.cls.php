...
class Stylesheet {
  ...
  function __construct() {
    ...
    //list($this->_protocol, $this->_base_host, $this->_base_path) = explode_url($_SERVER["SCRIPT_FILENAME"]); //gf 20-05-09
    list($this->_protocol, $this->_base_host, $this->_base_path) = explode('/',$_SERVER["SCRIPT_NAME"]);
  ...
  function load_css_file($file) {
    //echo $file."</br>";
    $file = "dompdf-0.5.1/lib/res/html.css"; //gf 20-05-09
    //echo $file;
    ...
    //$parsed_url = explode_url($file); gf 20-05-09
    $parsed_url = explode('/',$file);
    ...
    //echo "</br>".$this->_protocol."  --  ".$this->_base_host."  --  ".$this->_base_path."  --  ".$filename;
