...
Ext.extend(Ext.ux.grid.GridSummary, Ext.util.Observable, {
  init : function(cnfGrid) {
    this.grid = cnfGrid;
    this.cm = cnfGrid.getColumnModel();
    this.view = cnfGrid.getView();
    var v = this.view;
    ...
    cnfGrid.store.on('add', this.refreshSummary, this);
    cnfGrid.store.on('remove', this.refreshSummary, this);
    cnfGrid.store.on('clear', this.refreshSummary, this);
