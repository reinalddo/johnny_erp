...
var hBar = new ItemStyle(125, 0, '', 0, 0, '15#336699', '10#6699CC', 'highText', 'highText', '', '',
...
if (location.pathname.lastIndexOf(".") > 0 ){
    var Base = window.location.protocol + "//" + window.location.host +
               location.pathname.substr(0,location.pathname.substr(0,location.pathname.lastIndexOf("/")).lastIndexOf("/")) + "/";
}
else var Base = window.location.protocol + "//" + window.location.host + location.pathname + "/";
...
*/
	...
	startMenu('mCo', true, 0, 22, 150, subM);
        ...
        startMenu('mCoRe', true, 90, 10, 170, subM);
            ...
            addItem('Lista General de Activos ',    Base + 'Co_Files/CoAdAu_resgen.rpt.php',     '');
	...
	startMenu('mIn', true, 0, 22, 150, subM);
    	...
    	startMenu('InTr', true, 90, 10, 150, subM);
    	    addItem('Ingreso / Modificacin',       Base + 'In_Files/InTrTr_Cabe.php?pAplic=IN',                 '');
	...
	startMenu('mEm', true, 0, 22, 150, subM);
	    ...
	    addItem('Tramites',         			'mTrTr',            'sm:');
	    addItem('Memos a Clientes',          	'mTrMe',            'sm:');
        addItem('Seguimiento de Tramites',     	'mTrAc',   'sm:');	
	    addItem('',                   			'mLiTj',             'sm:');
	    addItem('Modulo de Clientes',       	'../Sv_Files/SvTrTr_clieMenu.html',              '');
	    addItem('Estadisticas',             	'mTrEs',              'sm:');

        startMenu('mTrTr', true, 90, 10, 200, subM);
	        addItem('Nuevo Tramite ***',           	Base + 'Sv_Files/SvTrTr_orddata.php',   '');
	        addItem('Consulta de Tramites',     	Base + 'Sv_Files/SvTrTr_search.php',   '');
	        addItem('Nueva Garantia',           	Base + 'Sv_Files/SvTrTr_garantiasfrm.php',   '');
	        addItem('Consulta de Garantias',        Base + 'Sv_Files/SvTrTr_garantiasgrid.php',   '');			
	        addItem('Facturacion',     				Base + 'Sv_Files/SvTrTr_porfacturar.php',   '');
	        addItem('Reportes',                  	Base + 'Sv_Files/SvTrTr_repcond.php',   '');

        startMenu('mTrMe', true, 90, 10, 200, subM);
	        addItem('Nuevo Memo',           		Base + 'Sv_Files/SvTrTr_memosmant.php',   '');
	        addItem('Consulta de Memos',     	    Base + 'Sv_Files/SvTrTr_memosearch.php',   '');

        startMenu('mTrEs', true, 90, 10, 200, subM);
	        addItem('Estadistica General-Anual',    Base + 'Sv_Files/SvAdEs_esttrami.php',   '');
            addItem('Estadistica General Mensual',  Base + 'Sv_Files/SvAdEs_estgralmes.php',   '');
	        addItem('Estadistica Clientes-Tramites',Base + 'Sv_Files/SvAdEs_esttrames.php',   '');
	        addItem('Estadistica Facturacin',      Base + 'Sv_Files/SvAdEs_esttratip.php',   '');
	        addItem('Resumen Fact/Clientes',        Base + 'Sv_Files/SvTrAc_estadcliecostgrid.php',   '');
	
	    startMenu('mTrAc', true, 90, 10, 200, subM);
            addItem('Actividades',                  Base + 'Sv_Files/SvTrAc_actividadesgrid.php',     '');
	...
	startMenu('mSe', true, 0, 22, 150, subM);
	    ...
	    addItem('Mdulos',              		Base + 'Se_Files/SeGeMo_top.php', '');
