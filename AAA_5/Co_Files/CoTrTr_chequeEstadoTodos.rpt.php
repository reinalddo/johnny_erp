 ...
 *    @rev  esl   13/10/2010  se elimino el usuario de la consulta porque hacía que se repitan los cheques cuando eran modificados por distintos usuario
 */
...
while ($r2 = $rs2->fetchRow()){
    ...
    $sSql = "select distinct '' empresa".$select."
        ...
        where tipo=1 and com_FecContab between  '".$fecIni."' and '".$fecFin."' and det_ValCredito<>0 and operacion=1
        order by banco,cheque ";
        
        
        
        //where tipo=1 and fecRegistro between  '".$fecIni."' and '".$fecFin."' and det_ValCredito<>0 and operacion=1
