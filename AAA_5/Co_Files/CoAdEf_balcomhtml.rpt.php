<?php
/*
*   @date   Nov/17/08           Generar en formato HTML
...
function after_group_GRU (&$rpt, &$group) {
    global $db;
    global $gaAcum, $sgCtaPat, $sgCtaRes, $glColSal;
    $rpt->pdf->y -=15;
    $slTexto = '';
    $flAcum = 0;
...
$sgCtaRes = NZ(fDBValor($db, "genparametros", "par_Valor1", "par_Clave = 'CTARES'"), '6');
...
if ($slTipo == 'GEN' || $slTipo == 'PYG') { // Procesar Balance General 0 PIG
    ...
    elseif ($slTipo == 'GEN')    $rep->title="ESTADO DE PERDIDAS Y GANANCIAS";
