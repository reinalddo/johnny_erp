...
//////////////// [ Controles de Panel Reportes ] ////////////////////
    ...
    // esl	21/07/2010	estos reportes se incluyeron dentro de la consulta de una cotizacion.	 
...
function fIngresaCabConcil(fechaCorte) {
		...
		Ext.Msg.alert('AVISO', "Cotización Creada"+fechaCorte);
		fBuscarNuevo();
            },
