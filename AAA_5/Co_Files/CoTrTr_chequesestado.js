...
Ext.onReady(function(){
    ...
    var store = new storeX({
	    proxy: new Ext.data.HttpProxy({
            method:"GET",
            url: (!sgLoadUrl)? 'CoTrTr_chequesestado.php' : sgLoadUrl  
        }),
    ...
    */
    ...
    name="Car";
    app.cheque.gridEst = new Ext.ux.AutoGridPanel({
        title:''
        ,plugins: [filters]
        //,id:'gridConciliacion'
        ,height: 200
        ...
        ,bbar: new Ext.PagingToolbar({
            ...
            items:[
                '-',{
                        ...
                        handler: function(){basic_printGrid(app.cheque.gridEst);}
                    }                
        ]})
    ...
    //if(!Ext.getCmp("gridConciliacion")){
        ...
        olPanel.add(app.cheque.gridEst);
    //}
    
    
    app.cheque.gridEst.store.load({params: {meta: true, start:0, limit:9999, sort:'com_FecContab', dir:'DESC'}});
...
function fGrabaEstado(){
    if (0 == app.cheque.gridEst.getSelectionModel().getCount()){
    ...
    var dsCmbEstado2 = 	new Ext.data.Store({
            ...
            baseParams: {id : 'CoTrTr_estadoDef'}
    });
...
function fConfirmarEstado(){
        debugger;
    var alSel = app.cheque.gridEst.getSelectionModel().selections;
