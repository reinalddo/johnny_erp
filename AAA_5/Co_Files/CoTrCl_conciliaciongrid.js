...
Ext.onReady(function(){
    ...
    app.cl.gridBuscar.store.load({params: {meta: true, start:0, limit:21, sort:'con_FecCorte', dir:'DESC'}});
    ...
    app.cl.gridBuscar.getSelectionModel().on('rowselect', function(sm, rowIdx, r) {
		...
		var slidRegistro = r.data.con_IdRegistro;
                var slUrl = "CoTrCl_conciliaciongridDet.php?init=1&pAuxil=" + Ext.getCmp("txt_bancos").getValue() + "&fecCorte=" + slFec + "&pCuenta=" + Ext.getCmp("txt_cuenta").getValue()+ "&pIdRegistro=" + slidRegistro;
