...
//
    $alSql[] = "SELECT  concat(per_Apellidos,' ', per_nombres) AS 'NOM',
                        sum(det_valdebito) -sum(det_valcredito) AS 'SAL'
                FROM genparametros 
			JOIN  condetalle ON par_clave = 'CLIBRO' and  par_valor1 = det_codcuenta
...
$rep->colOpt['NOM']['width']=280;
$rep->colOpt['SAL']['width']=200;
