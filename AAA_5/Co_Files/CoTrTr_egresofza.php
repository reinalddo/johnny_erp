...
<body style="margin-left: 0cm; margin-top:0.8cm">
<table width="22cm">
  <tr>
	...
	/*$slTexto = str_pad($slTexto, 75,"*");
	$slTexto = str_pad($slTexto . " " , 120,"*");*/
    ...
    <td style="width:15cm;   height: 0.2cm; font-size:10pt; font-weight:bolder"><?php echo $r1->REC;?>     	</td>
