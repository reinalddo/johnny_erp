...
function &fDefineQry(&$db, $pQry=false){
  ...
  // ECHO 'condicion: '.$slCond; 
   ...
   $slSqlH ="select
		  ...
		  ELSE det_ValTotal
		  END AS 'TOTAL'
		  ,com_FecTrans AS fecTrans
		  ,com_FecContab AS fecContab
		  ,com_FecVencim AS fecVencim
		  ,com_Libro AS codLibro
		  ...
		  gentasacabecera,
		  gentasadetalle
		  JOIN genparametros lib on par_Clave = 'CLIBRO' 
	       WHERE 
		  com_TipoComp='FA' AND 
		  tsc_ID=tsd_ID AND
		  lib.par_Secuencia = com_Libro AND
