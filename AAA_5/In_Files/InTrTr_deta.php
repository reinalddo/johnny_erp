...
//Class_Initialize Event @2-54C08CC9
    function clsEditableGridInTrTr_detalle()
    {
        ...
        $this->det_CodItem = new clsControl(ccsTextBox, "det_CodItem", "Código de Item", ccsInteger, "");
...
//FormScript Method @2-D6BD4AB0
    function FormScript($TotalRows)
    {
        ...
        $script .= "var " . $this->ComponentName . "act_DescripcionID = 4;\n";
        $script .= "var " . $this->ComponentName . "det_CanDespachadaID = 5;\n";
        $script .= "var " . $this->ComponentName . "det_UniMedidaID = 6;\n";
        $script .= "var " . $this->ComponentName . "det_CantEquivaleID = 7;\n";
        $script .= "var " . $this->ComponentName . "det_CosUnitarioID = 8;\n";
        $script .= "var " . $this->ComponentName . "det_CosTotalID = 9;\n";
        $script .= "var " . $this->ComponentName . "det_ValUnitarioID = 10;\n";
        $script .= "var " . $this->ComponentName . "det_ValTotalID = 11;\n";
        $script .= "var " . $this->ComponentName . "det_RefOperativaID = 12;\n";
        $script .= "var " . $this->ComponentName . "det_EstadoID = 13;\n";
        $script .= "var " . $this->ComponentName . "det_DestinoID = 14;\n";
        $script .= "var " . $this->ComponentName . "DeleteControl = 15;\n";
        $script .= "var " . $this->ComponentName . "hdMultiID = 16;\n";
        $script .= "var " . $this->ComponentName . "act_UniMedidaID = 17;\n";
        $script .= "var " . $this->ComponentName . "hdDivisorID = 18;\n";
...
//Open Method @2-B4A291E1
    function Open()
    {
        ...
        "";
        $this->SQL = "SELECT com_RegNumero, com_NumPeriodo, invdetalle.*,  left(concat(act_Descripcion,' ', act_descripcion1),35) as act_descripcion, " .
        "       act_UniMedida, umite.uni_descripcion, umdet.uni_descripcion, " .
        "       tab_multiplicador, tab_divisor " .
...
$FileName = "InTrTr_deta.php";
$Redirect = "";
$TemplateFileName = "InTrTr_deta.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page
