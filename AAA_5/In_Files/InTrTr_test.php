...
/* fah */
        if (isset($_GET['com_RefOperat']) && strlen($_GET['com_RefOperat']) >0 ) {
            if (strlen($this->Where) > 1) $this->Where .= " AND ";
            $this->Where .= "com_RefOperat=" . $_GET['com_RefOperat'];
        }
