<?php /* Smarty version 2.6.18, created on 2010-09-03 10:28:11
         compiled from CoTrTr_chequeEstado.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'CoTrTr_chequeEstado.tpl', 24, false),array('block', 'report_header', 'CoTrTr_chequeEstado.tpl', 27, false),array('block', 'report_detail', 'CoTrTr_chequeEstado.tpl', 83, false),array('block', 'report_footer', 'CoTrTr_chequeEstado.tpl', 105, false),array('modifier', 'date_format', 'CoTrTr_chequeEstado.tpl', 31, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_header', array('group' => 'banco')); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    ...
    <tr style="font-weight:bold; text-align:center; vertical-align:middle;">
            ...
            <?php if (( 1 == $this->_tpl_vars['opc'] )): ?>
	      <td class="headerrow">FECHA EMISION</td>
	    <?php endif; ?>
            <?php if (( 2 == $this->_tpl_vars['opc'] || 4 == $this->_tpl_vars['opc'] )): ?>
	      <td class="headerrow">FECHA CONFIRM.</td>
	    <?php endif; ?>
	    <?php if (( 4 >= $this->_tpl_vars['opc'] )): ?>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr>
        ...
        <?php if (( 1 == $this->_tpl_vars['opc'] || 2 == $this->_tpl_vars['opc'] || 4 == $this->_tpl_vars['opc'] )): ?>
	  <td><?php echo $this->_tpl_vars['rec']['fecEmi']; ?>
</td>
	<?php endif; ?>
        	  		<?php if (( 4 >= $this->_tpl_vars['opc'] )): ?>
