<?php /* Smarty version 2.6.18, created on 2009-04-01 15:41:30
         compiled from OpTrTr_restarjdiamarc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'OpTrTr_restarjdiamarc.tpl', 11, false),array('block', 'report_header', 'OpTrTr_restarjdiamarc.tpl', 13, false),array('block', 'report_detail', 'OpTrTr_restarjdiamarc.tpl', 65, false),array('block', 'report_footer', 'OpTrTr_restarjdiamarc.tpl', 77, false),array('modifier', 'upper', 'OpTrTr_restarjdiamarc.tpl', 33, false),array('modifier', 'number_format', 'OpTrTr_restarjdiamarc.tpl', 71, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report', array('recordset' => $this->_tpl_vars['agData'],'record' => 'rec','groups' => "txt_vapor, txt_producto, txt_nombre",'resort' => true)); $_block_repeat=true;smarty_block_report($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
<?php $this->_tag_stack[] = array('report_header', array('group' => 'txt_vapor')); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	  <thead>
		<tr >
		  ...
		  <?php $_from = $this->_tpl_vars['agCabeGru']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
?>
 ...
 &nbsp;  &nbsp; &nbsp; &nbsp; VAPOR: <?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['txt_vapor'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
    ...
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['col']):
?>
				<td class="colhead headerrow"  colspan=<?php echo $this->_tpl_vars['col']['long']; ?>
><?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</td>
		  <?php endforeach; endif; unset($_from); ?>
...
">
		<?php if ($this->_tpl_vars['rowcls'] == 'rowpar'): ?><?php $this->_tpl_vars['rowcls'] = 'rowimpar'; ?><?php endif; ?> 
		  <td class="colnom " style="width:80px;" ><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['txt_codigos'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</td>
		  <td class="colnom" style="width:120px; white-space: nowrap; " ><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['txt_nombre'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</td>
			<?php $_from = $this->_tpl_vars['agNombCol']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['col']):
?>
...
<?php $this->_tag_stack[] = array('report_footer', array('group' => 'txt_producto')); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<tr ><td>&nbsp;</td>
			<td style="font-weight:bold !important">SUMA <?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['txt_producto'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</td>
			  <?php $_from = $this->_tpl_vars['agNombCol']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['col']):
?>
...
<?php $this->_tag_stack[] = array('report_footer', array('group' => 'txt_vapor')); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<tr ><td>&nbsp;</td>
			<td style="font-weight:bold !important">SUMA <?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['txt_vapor'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</td>
			  <?php $_from = $this->_tpl_vars['agNombCol']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['col']):
?>
