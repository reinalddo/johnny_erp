<?php /* Smarty version 2.6.18, created on 2009-04-06 16:48:42
         compiled from RtTrTr_Librocompras.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'RtTrTr_Librocompras.tpl', 15, false),array('block', 'report_header', 'RtTrTr_Librocompras.tpl', 16, false),array('block', 'report_detail', 'RtTrTr_Librocompras.tpl', 73, false),array('block', 'report_footer', 'RtTrTr_Librocompras.tpl', 109, false),array('modifier', 'date_format', 'RtTrTr_Librocompras.tpl', 18, false),array('modifier', 'number_format', 'RtTrTr_Librocompras.tpl', 87, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_header', array()); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<tr style="font-weight:bold; text-align:center; vertical-align:middle;">
	  ...
	  <td rowspan=2 class="headerrow"><strong>Ret.Fte. 1%</strong></td>
	  <td rowspan=2 class="headerrow"><strong>Ret.Fte. 2%</strong></td>
	  <td rowspan=2 class="headerrow"><strong>Ret.Fte. 5%</strong></td>
	  <td rowspan=2 class="headerrow"><strong>Ret.Fte. 8%</strong></td>
	  <td rowspan=2 class="headerrow"><strong>Ret.Fte. 25%</strong></td>
	  <td rowspan=2 class="headerrow"><strong>Total a Pagar</strong></td>
	  <td rowspan=2 class="headerrow"><strong>No.Comp.Ret.</strong></td>
	</tr>
        <tr style="font-weight:bold; text-align:center; vertical-align:middle;">
	    
            <td class="headerrow"><strong>Establecimiento</strong></td>
            <td class="headerrow"><strong>Punto Emision</strong></td>
            <td class="headerrow"><strong>Secuencial</strong></td>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<td class="colnum " style="text-align:right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['montoIvaBienes'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
        ...
        <td class="colnum " style="text-align:right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['porRetBienes'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0) : smarty_modifier_number_format($_tmp, 0)); ?>
</td>
	...
	<td class="colnum " style="text-align:right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['porRetServicios'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0) : smarty_modifier_number_format($_tmp, 0)); ?>
</td>
	...
	<td class="colnum " style="text-align:right;"><?php echo $this->_tpl_vars['rec']['RET_1']; ?>
</td>
        <td class="colnum " style="text-align:right;"><?php echo $this->_tpl_vars['rec']['RET_2']; ?>
</td>
        <td class="colnum " style="text-align:right;"><?php echo $this->_tpl_vars['rec']['RET_5']; ?>
</td>
        <td class="colnum " style="text-align:right;"><?php echo $this->_tpl_vars['rec']['RET_8']; ?>
</td>
        <td class="colnum " style="text-align:right;"><?php echo $this->_tpl_vars['rec']['RET_25']; ?>
</td>
	...
	<?php $this->assign('tot', $this->_tpl_vars['rec']['TOTAL_COMPRA']-$this->_tpl_vars['ret']); ?>
        ...
        <td class="colnum "><?php echo $this->_tpl_vars['rec']['COMPROB']; ?>
</td>
    </tr>
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>

<?php $this->_tag_stack[] = array('report_footer', array()); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr><td colspan=30>&nbsp</td></tr>
    <tr>
	...
	<td class="colnum headerrow"><?php echo ((is_array($_tmp=$this->_tpl_vars['sum']['total_pagar'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
        <td></td>
    </tr>
    </table>
