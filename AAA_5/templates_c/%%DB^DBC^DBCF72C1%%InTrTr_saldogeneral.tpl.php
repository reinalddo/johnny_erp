<?php /* Smarty version 2.6.18, created on 2009-07-14 09:58:03
...
<?php $this->_tag_stack[] = array('report_footer', array('group' => 'desGru')); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr class="subtotal">
        ...
        <td class="num"></td>
        <td class="num"></td>
	<td class="num"><?php echo ((is_array($_tmp=$this->_tpl_vars['sum']['SAC']*$this->_tpl_vars['sum']['PUN'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
        <td class="num"></td>
    </tr>
