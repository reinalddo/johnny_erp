<?php /* Smarty version 2.6.18, created on 2009-05-13 11:07:52
         compiled from CoTrTr_resumengasto.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'CoTrTr_resumengasto.tpl', 33, false),array('block', 'report_header', 'CoTrTr_resumengasto.tpl', 34, false),array('block', 'report_detail', 'CoTrTr_resumengasto.tpl', 63, false),array('block', 'report_footer', 'CoTrTr_resumengasto.tpl', 77, false),array('modifier', 'date_format', 'CoTrTr_resumengasto.tpl', 38, false),array('modifier', 'number_format', 'CoTrTr_resumengasto.tpl', 73, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<td nowrap class="izq bordeDer"><?php echo $this->_tpl_vars['rec']['MES']; ?>
        ...
        <td class="izq bordeDer"><?php echo $this->_tpl_vars['rec']['AREA']; ?>
</td>
        <td class="izq bordeDer"><?php echo $this->_tpl_vars['rec']['CENTRO']; ?>
</td>
        <td class="izq bordeDer"><?php echo $this->_tpl_vars['rec']['CLASE']; ?>
</td>
