<?php /* Smarty version 2.6.18, created on 2011-07-22 17:44:33
         compiled from CoTrTr_chequeEstadoTodos.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'CoTrTr_chequeEstadoTodos.tpl', 24, false),array('block', 'report_header', 'CoTrTr_chequeEstadoTodos.tpl', 27, false),array('block', 'report_detail', 'CoTrTr_chequeEstadoTodos.tpl', 91, false),array('block', 'report_footer', 'CoTrTr_chequeEstadoTodos.tpl', 126, false),array('modifier', 'date_format', 'CoTrTr_chequeEstadoTodos.tpl', 31, false),array('modifier', 'cat', 'CoTrTr_chequeEstadoTodos.tpl', 101, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_header', array()); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    ...
    <table border=1 cellspacing=0 >
	    <?php $this->assign('totCol', $this->_tpl_vars['agTot']+3); ?>
...
<?php $this->_tag_stack[] = array('report_header', array('group' => 'banco')); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr style="margin-top:20px;margin-bottom:20px;padding-bottom:20px;">
        <td colspan=<?php echo $this->_tpl_vars['totCol']; ?>
 style="padding-top:20px; text-align:center; font-size:14px;"><strong>BANCO: </strong><?php echo $this->_tpl_vars['rec']['banco']; ?>
</td>
    </tr>
...
<br />-->
                ...
                <td class="headerrow"><strong>Fec.<?php echo $this->_tpl_vars['curr_id']; ?>
</strong></td>
...
?>
                <!--id: <?php echo $this->_tpl_vars['curr_id']; ?>
<br />-->
            <?php $this->assign('col', ((is_array($_tmp=$this->_tpl_vars['curr_id'])) ? $this->_run_mod_handler('cat', true, $_tmp, 'fecha') : smarty_modifier_cat($_tmp, 'fecha'))); ?>
                        <?php if (( $this->_tpl_vars['rec'][$this->_tpl_vars['curr_id']] == null )): ?>
                <td class="headerrow"><strong></strong></td>
                <td class="headerrow"><strong></strong></td>
            <?php else: ?>
                <td class="headerrow" style='text-align:center;'>x</td>
                <td class="headerrow" style='text-align:center;'><?php echo ((is_array($_tmp=$this->_tpl_vars['rec'][$this->_tpl_vars['col']])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</td>
            <?php endif; ?>
...
<?php $this->_tag_stack[] = array('report_footer', array('group' => 'banco')); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr class="subtotal">
        ...
        <td colspan=<?php echo $this->_tpl_vars['agTot']; ?>
></td>
