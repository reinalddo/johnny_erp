...
//Class_Initialize Event @2-94F7786C
    function clsRecordfiscompras()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->autorizacion = new clsControl(ccsTextBox, "autorizacion", "Autorizacion", ccsInteger, "", CCGetRequestParam("autorizacion", $Method));
            ...
            $this->autRetencion1 = new clsControl(ccsTextBox, "autRetencion1", "Aut Retencion1", ccsInteger, "", CCGetRequestParam("autRetencion1", $Method));
            ...
            $this->porcentajeAir = new clsControl(ccsTextBox, "porcentajeAir", "Porcentaje Air", ccsInteger, Array(False, 2, ".", ",", False, "", "", 1, True, ""), CCGetRequestParam("porcentajeAir", $Method));
            ...
            $this->autModificado = new clsControl(ccsTextBox, "autModificado", "Aut Modificado", ccsInteger, Array(True, 0, "", "", False, Array("0", "0", "0", "0", "0", "0", "0"), "", 1, True, ""), CCGetRequestParam("autModificado", $Method));
            ...
            $this->anio = new clsControl(ccsTextBox, "anio", "Año de Refrendo", ccsText, "", CCGetRequestParam("anio", $Method));
...
//Show Method @2-215D78A1
    function Show()
    {
        ...
        if(!$this->FormSubmitted)
        {
            $this->Label2->SetText($this->EditMode ? "MODIFICACION" : "AÑADIR");
        }
...
//DataSourceClass_Initialize Event @2-4BDFF98A
    function clsfiscomprasDataSource()
    {
        ...
        $this->autorizacion = new clsField("autorizacion", ccsInteger, "");
        ...
        $this->autRetencion1 = new clsField("autRetencion1", ccsInteger, "");
        ...
        $this->autModificado = new clsField("autModificado", ccsInteger, "");
...
//Insert Method @2-3D79D516
    function Insert()
    {
        ...
        $this->cp["autorizacion"] = new clsSQLParameter("ctrlautorizacion", ccsInteger, "", "", $this->autorizacion->GetValue(), "", false, $this->ErrorBlock);
        ...
        $this->cp["porcentajeAir"] = new clsSQLParameter("ctrlporcentajeAir", ccsInteger, Array(False, 2, ".", ",", False, "", "", 1, True, ""), "", $this->porcentajeAir->GetValue(), 0, false, $this->ErrorBlock);
        ...
        $this->cp["autRetencion1"] = new clsSQLParameter("ctrlautRetencion1", ccsInteger, "", "", $this->autRetencion1->GetValue(), 0, false, $this->ErrorBlock);
        ...
        $this->cp["autModificado"] = new clsSQLParameter("ctrlautModificado", ccsInteger, "", "", $this->autModificado->GetValue(), 0, false, $this->ErrorBlock);
...
//Update Method @2-62F082D6
    function Update()
    {
        ...
        $this->cp["porcentajeAir"] = new clsSQLParameter("ctrlporcentajeAir", ccsInteger, Array(False, 2, ".", ",", False, "", "", 1, True, ""), "", $this->porcentajeAir->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["valRetAir"] = new clsSQLParameter("ctrlvalRetAir", ccsMemo, "", "", $this->valRetAir->GetValue(), 0, false, $this->ErrorBlock);
        ...
        $this->cp["autRetencion1"] = new clsSQLParameter("ctrlautRetencion1", ccsInteger, "", "", $this->autRetencion1->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["docModificado"] = new clsSQLParameter("ctrldocModificado", ccsText, "", "", $this->docModificado->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["fechaEmiModificado"] = new clsSQLParameter("ctrlfechaEmiModificado", ccsDate, Array("dd", "/", "mmm", "/", "yyyy"), Array("yyyy", "-", "mm", "-", "dd", " ", "HH", ":", "nn", ":", "ss"), $this->fechaEmiModificado->GetValue(), 0000-00-00, false, $this->ErrorBlock);
        ...
        $this->cp["autModificado"] = new clsSQLParameter("ctrlautModificado", ccsInteger, "", "", $this->autModificado->GetValue(), "", false, $this->ErrorBlock);
