...
{
?>
	<DIV STYLE="POSITION:absolute; LEFT:150px; TOP:145px; "><?php echo $r['NOM'];?></DIV>
	<DIV STYLE="POSITION:absolute; LEFT:1350px; TOP:145px;"><?php echo $r['FEC'];?></DIV>
  	<DIV STYLE="POSITION:absolute; LEFT:195px; TOP:190px;"><?php echo $r['RUC'];?></DIV>
	<DIV STYLE="WIDTH:400px; font-size: 14px; POSITION:absolute; LEFT:1350px; TOP:190px;"><?php echo $r['TIP']?></DIV>
  	<DIV STYLE="POSITION:absolute; LEFT:195px; TOP:220px;"><?php echo $r['Direcc'];?></DIV>
	<DIV STYLE="WIDTH:200px; POSITION:absolute; LEFT:1350px; TOP:220px; "><?php echo $r['FAC'];?></DIV>
<?php
	if($r['MIB']>0)
	{
