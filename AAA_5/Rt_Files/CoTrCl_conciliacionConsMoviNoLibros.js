...
Ext.onReady(function(){
    ...
    */
	...
	,plugins: [filters]
        ...
        /*,onRender:function() {
                //debugger;
                //grid2.store.load({params:{meta: true, start:0, limit:9999, sort:'com_FecContab', dir:'DESC'}})
            }*/
       /*,afterlayout:{scope:this, single:true, fn:function() {
                    debugger;
                     grid2.store.load({params:{start:0, limit:10}});
                }
            }*/
    });
    ...
    this.grid2.store.load({params: {meta: true, start:0, limit:100, sort:'com_FecContab', dir:'DESC'}});// @TODO: load method must be applied over a dinamic referenced object, not 'this.grid2' referenced
     
    grid2.getView().refresh();
    
    /*this.gridFoot = this.grid2.getView().getFooterPanel(true);
    ...
    this.grid2.store.load({params: {meta: true, start:0, limit:10, sort:'com_FecContab', dir:'DESC'}});// @TODO: load method must be applied over a dinamic referenced object, not 'this.grid2' referenced
    */
    /*grid2.getSelectionModel().on('rowselect', function(pSm, pRid, pRec) {
...
/*  this.grid2.onBeforerender=function(){
...
function fAnular(){
    ...
    if (0 == grid2.getSelectionModel().getCount()){
        Ext.Msg.alert('Alerta','Por favor seleccione comprobante a anular');
        return;
    }
        
    var slTipoComp = grid2.getSelectionModel().getSelected().data.com_TipoComp;
    var slNumComp = grid2.getSelectionModel().getSelected().data.com_NumComp;
    var slRegNum = grid2.getSelectionModel().getSelected().data.com_RegNumero;
    var slFecCorte = new Date().format('Y-m-d');//grid2.getSelectionModel().getSelected().data.fecCorte;
    var slConcepto = grid2.getSelectionModel().getSelected().data.com_Concepto;
