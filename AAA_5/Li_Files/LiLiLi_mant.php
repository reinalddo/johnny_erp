...
//Update Method @2-958DED8E
    function Update()
    {
        ...
        $this->SQL = "UPDATE liqliquidaciones SET "
             ...
             . "liq_Cantidad=" . $this->ToSQL($this->cp["liq_Cantidad"]->GetDBValue(), $this->cp["liq_Cantidad"]->DataType) . ", "
             . "liq_ValUnitario=" . $this->ToSQL($this->cp["liq_ValUnitario"]->GetDBValue(), $this->cp["liq_ValUnitario"]->DataType) . ", "
             . "liq_ValTotal=" . $this->ToSQL($this->cp["liq_ValTotal"]->GetDBValue(), $this->cp["liq_ValTotal"]->DataType) . ", "
             . "liq_EsGenerado=" . $this->ToSQL($this->cp["liq_EsGenerado"]->GetDBValue(), $this->cp["liq_EsGenerado"]->DataType);
