...
function fCierraComprob(&$db, $fSuma, &$lastrec) {
    ...
    if ($fSuma <> 0) { //                                                                   Procesaer el asiento de cierre para el productor previo
        ...
        }else  $lastrec['det_idauxiliar'] = AplicaAuxil(true, $agPla['TCI'], $agPla['ACI'], $ilUltimoProd);
...
switch ($ilEstadoProc) {
    case 26:
        ...
        $ilInd = 1;
    case 6:
        echo "<br>PASO $ilEstadoProc.-  CONTABILIZACION CHEQUE VOUCHER :</font></td></tr><tr><td>";
