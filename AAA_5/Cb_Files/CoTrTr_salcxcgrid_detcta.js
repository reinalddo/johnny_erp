...
Ext.onReady(function(){
    ...
    var store = new storeX({
	    proxy: new Ext.data.HttpProxy({
            method:"GET",
            url: (!sgLoadUrl)? 'CoTrTr_salcxcgrid_detcta.php' : sgLoadUrl  
        }),
    ...
    */
    ...
    name="Cnt";
    app.consCta.grid1 = new Ext.ux.AutoGridPanel({
        title:'',
		//plugins: [filters],
        height: 210,
        width: 'auto',//800,
    ...
    app.consCta.grid1.store.load({params: {meta: true, start:0, limit:9999, sort:'ID', dir:'DESC'}});// @TODO: load method must be applied over a dinamic referenced object, not 'this.grid1' referenced
