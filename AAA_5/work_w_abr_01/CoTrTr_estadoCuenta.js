...
*  
*  proceso de Autogrid
*   consulta los movimientos de una persona en un rango de fechas determinado
*   parametros:
...
Ext.onReady(function(){
    ...
    var gridView2 = new Ext.grid.GridView({ 
       //forceFit: true, 
    ...
    Ext.namespace("app", "app.estCta");		     // Iniciar namespace cart
    ...
    */
    ...
    name="Cnt";
    gridEstCta = new Ext.ux.AutoGridPanel({
        id:'cajaEstCta'
        ,title:''
	,plugins: [filters]
        ,height: 300
        ...
        ,bbar: new Ext.PagingToolbar({
            ...
            ,{
                ...
                handler: function(){basic_printGrid2(gridEstCta, 'Estado de Cuenta');}
            }]
        })
    ...
    Ext.getCmp(gsObj).add(gridEstCta);
   
    //Ext.getCmp('paneles').doLayout();
    Ext.getCmp(gsObj).doLayout();
    this.gridEstCta.store.load({params: {meta: true, start:0, limit:100, sort:'com_FecContab', dir:'DESC'}});// @TODO: load method must be applied over a dinamic referenced object, not 'this.grid1' referenced
     
    gridEstCta.getView().refresh();
