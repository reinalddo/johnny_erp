...
<div id="apDiv11" >
  <table width="100%" border="0">
    <tr>
      <td class="style2" colspan="3"><div align="center">EGRESO A PROUCTORES # <?php echo $row_Recordset1['COMPR']; ?></div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="style2">PRODUCTOR:</td>
      <td class="style4" colspan="2"><?php echo $row_Recordset1['RECEP']; ?></td>
    </tr>
    <tr>
      <td class="style2">BODEGA:</td>
      <td class="style3"  colspan="2"><?php echo $row_Recordset1['BODEG']; ?></td>
    </tr>
    <tr>
  ...
  <br /> 
    ...
    <p align="center"><a href="javascript:window.print()"><img src="../Images/imprimir.gif" alt="Imprimir" width="75" height="18" border=1 style="border-color:#000000"/></a></p>
    <p align="center">&nbsp;</p>
</div>
