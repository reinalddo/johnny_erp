...
Ext.onReady(function(){
    ...
    */
    ...
    name="Car";
    app.cheque.gridCheqSubidos = new Ext.ux.AutoGridPanel({
        title:''
        ,plugins: [filters]
        //,id:'gridConciliacion'
        ,height: 200
        ...
        ,bbar: new Ext.PagingToolbar({
            ...
            items:[
                '-',{
                        ...
                        handler: function(){basic_printGrid(app.cheque.gridCheqSubidos);}
                    }                
        ]})
    ...
    //if(!Ext.getCmp("gridConciliacion")){
        ...
        olPanel.add(app.cheque.gridCheqSubidos);
    //}
    
    
    app.cheque.gridCheqSubidos.store.load({params: {meta: true, start:0, limit:9999, sort:'com_FecContab', dir:'DESC'}});
