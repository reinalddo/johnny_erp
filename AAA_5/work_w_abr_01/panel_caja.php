...
$goPanel->addCssFile("../LibJava/ext-2.0/resources/css/xtheme-slate");
...
echo "-----";
*/
//$goPanel->addBodyScript("../LibJava/ext-2.0/ux/tree/column-tree");
$goPanel->addBodyScript("../LibJava/ext-2.0/ux/tree/ColumnNodeUI");
