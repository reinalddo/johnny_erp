...
{report_header group="det_CodCuenta"}
    <tr ><td colspan=7><strong>CUENTA: </strong>{$rec.det_CodCuenta}: {$rec.txt_NombCuenta}</td>
    </tr>
    {*assign var=acum  value=0*}
{/report_header}
...
{report_header group="det_CodAuxiliar"}
    <tr style="height:40px; vertical-align:middle;">
      <td colspan=7 style="vertical-align:bottom;"><strong>AUXILIAR: </strong>{$rec.det_CodAuxiliar}: {$rec.txt_NombAuxiliar}</td>
    </tr>
    {*assign var=acum  value=0*}
