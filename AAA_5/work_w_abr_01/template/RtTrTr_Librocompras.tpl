...
{report_detail}
	...
	<td class="colnum " style="text-align:right;">{$rec.montoIvaBienes|number_format:2}</td>
        <td class="colnum " style="text-align:right;">{$rec.porRetBienes|number_format:0}</td>
	...
	<td class="colnum " style="text-align:right;">{$rec.porRetServicios|number_format:0}</td>
	<td class="colnum " style="text-align:right;">{$rec.valorRetServicios|number_format:2}</td>
	<td class="colnum " style="text-align:right;">{$rec.RET_1}</td>
        <td class="colnum " style="text-align:right;">{$rec.RET_2}</td>
        <td class="colnum " style="text-align:right;">{$rec.RET_5}</td>
        <td class="colnum " style="text-align:right;">{$rec.RET_8}</td>
        <td class="colnum " style="text-align:right;">{$rec.RET_25}</td>
	...
	{assign var=tot value=$rec.TOTAL_COMPRA-$ret}
        ...
        <td class="colnum ">{$rec.COMPROB}</td>
    </tr>
{/report_detail}
