...
<div id="apDiv11" >
  <table width="100%" border="0">
    <!--DWLayoutTable-->
    <tr>
      <td height="17" colspan="5" valign="top" class="style2"><div align="center"><?php echo $row_Recordset1['TRADES'] . " # " . $row_Recordset1['COMPR']; ?></div></td> 
      <!-- @fah28/01/09-->
    </tr>
    <tr>
      <td width="124" height="34" class="style2">FECHA:</td>
      <td colspan="2"><span class="style4"><?php echo $row_Recordset1['FECHA']; ?> </span></td>
      <td colspan="2" valign="top"><span class="style2">SEM: </span><span class="style3"><?php echo $row_Recordset1['REFOP']; ?></span></td>
    </tr>
    <tr>
      <td height="32" class="style2"><?php echo $row_Recordset1['TXTEMI']; ?>:</td> <!-- @fah28/01/09-->
      <td width="124" valign="top" class="style4"><?php echo $row_Recordset1['BODEG']; ?></td>
	  <td width="134" valign="top" class="style2"><?php echo $row_Recordset1['TXTREC']; ?>:</td> 
	  <td  colspan="2" valign="top" class="style3"><?php echo $row_Recordset1['RECEP']; ?></td>
    <!-- @fah28/01/09-->
    </tr>
    <tr>
      <td height="17" valign="top" class="style2">CONCEPTO:</td>
      <!-- @fah28/01/09-->
      <td  colspan="3" valign="top" class="style4"><?php echo $row_Recordset1['CONCEP']; ?></td>
      <td width="206"></td>
    </tr>
    <tr>
      <td height="3"></td>
  ...
  <!--<br /> -->
    <table width="750" border="0" cellpadding="2" cellspacing="0">
      ...
      <tr>
        <td class="style5" colspan="4"><div align="right" class="style2"></div></td>
