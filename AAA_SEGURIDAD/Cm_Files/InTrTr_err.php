...
//Class_Initialize Event @5-A203767C
    function clsRecordInTrTr_qry()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->s_com_FecDigita = new clsControl(ccsTextBox, "s_com_FecDigita", "s_com_FecDigita", ccsDate, Array("dd", "/", "mm", "/", "yy"), CCGetRequestParam("s_com_FecDigita", $Method));
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                if(!CCGetEvent($this->Button_DoSearch->CCSEvents, "OnClick")) {
                    ...
                    $Redirect = "InTrTr.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", Array("Button_DoSearch", "btCancelar")));
                }
...
/* fah */
        ...
        if (strlen($this->Where && strlen($slRestr) >= 1) > 1) $this->Where .= " AND ";
...
echo "<br> SESION-Restr-In:";print_r($_SESSION["restr"]["InTrTr"]);
echo "<br> SESION-Restr-In:";print_r($_SESSION["restr"]["InTrTr"]["ACC"]);
