...
$sSql = "select com_NumComp,com_FecTrans, com_Receptor, p.per_RUC ruc, com_Concepto, com_FecContab, 
        ...
        /*det_ValUnitario*/ det_cosunitario,det_CosTotal ValTotal/*det_ValTotal*/, com_Usuario,
...
if($rs->EOF){
   ...
   $Tpl->assign("agFilas", $filas);
    ...
    if (!$Tpl->is_cached('InTrTr_ordencompraci.tpl')) {
            }
    
            $Tpl->display('InTrTr_ordencompraci.tpl');
}
?>