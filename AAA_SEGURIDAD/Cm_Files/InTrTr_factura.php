...
/*    if ($iva > 0){
   ...
   switch ($ilFmto){
      case 2 :
         ...
         break;
      case 3 :
         $slFmto = "InTrTr_facturablancoA4.tpl";
         break;
      case 4 :
         $slFmto = "InTrTr_facturacod.tpl"; //Formulario de Impresion para Codrigna
         break;
      case 5 :
         $slFmto = "InTrTr_facturaAsis.tpl"; //Formulario de Impresion para Asisbane
         break;
      case 6 :
         $slFmto = "InTrTr_facturaBalsh.tpl"; //Formulario de Impresion para Baloschi
         break;
      case 7 :
         $slFmto = "InTrTr_facturaSchaffry.tpl"; // Formato de impresion para Alex Schaffry
         break;
      case 8 :
         $slFmto = "InTrTr_facturaEncoser.tpl"; // Formato de impresion para Enconser
         break;
      default :
         $slFmto = "InTrTr_facturablanco.tpl"; //CASE 1 es Formulario de Impresion para Amenegsa
   }
