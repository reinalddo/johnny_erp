...
define("DBTYPE", "mysql");
define ("APPSRVR", $_SERVER['SERVER_NAME']);
define ("APP_DIR", "\SERVER\htdocs\AAA\AAA_SEGURIDAD");
define ("APP_URL", "http://" . APPSRVR . "/AAA/AAA_SEGURIDAD");
define ("DBSRVR", "localhost");
define ("DBUSER", "root");
define ("DBPASS", "xx");
define ("UT_DIR", "../Ut_Files");
if (isset($_SESSION["g_dbase"]) && strlen($_SESSION["g_dbase"]) > 2 )
    define ("DBNAME", $_SESSION["g_dbase"]);
else
    define ("DBNAME", "aaa_db");
//echo "DB: " . DBNAME;
define ("DATOS_CON", DBTYPE . "://" . DBUSER . ":" . DBPASS . "@" . DBSRVR . "/" . DBNAME );     // Cadena de conexion mysql para datos
define ("SEGUR_CON", DBTYPE . "://" . DBUSER . ":" . DBPASS . "@" . DBSRVR . "/seguridad");     // Cadena de conexion mysql para seguridad
$_SESSION["g_user"]='fah';
$_SESSION["g_pass"]='titoFaus';
$_SESSION["g_empr"]='J003';
$_SESSION["g_dbase"]='nueva_07';
$_SESSION["g_logged"]=1;
