<?php
/*
*	@rev JVL Nov15/13: garantizar que se grabe el valor default del emisor, cuando asi lo requiera la transacc.
*	@rev JVL Nov15/13: garantizar que se actualize las transacc asociadas al modificar fechas y/o productores
* 	@rev JVL Nov15/13: Incorporar restricciones en tipos de comprobante segun perfil ($_SESSION[IntrTr][ACC])
* 	*/
