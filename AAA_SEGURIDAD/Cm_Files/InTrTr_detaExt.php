...
//Open Method @2-B4A291E1
    function Open()
    {
        ...
        $this->SQL = "SELECT com_RegNumero, com_NumPeriodo, invdetalle.*,  det_cosunitario AS det_Cosunitario,
                det_valUnitario as det_ValUnitario, left(concat(act_Descripcion,' ', act_descripcion1),35) as act_descripcion, " .
...
$FileName = "InTrTr_detaExt.php";
$Redirect = "";
$TemplateFileName = "InTrTr_detaExt.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page
