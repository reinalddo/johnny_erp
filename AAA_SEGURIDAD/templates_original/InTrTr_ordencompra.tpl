...
{report_header}
	...
	<tr class="titulo bordeCompleto">
	  <td class=" bordeCompleto" style="width:4%;"><strong>Item</strong></td>
	  <td class=" bordeCompleto" style="width:5%;"><strong>Codigos</strong></td>
...
{report_detail}
	...
	<td nowrap class="der bordeDer">{$rec.det_CodItem}</td>
	...
	<td class="der bordeDer">{$rec.det_ValUnitario|number_format:4}</td>
...
{report_footer}
    ...
    <tr>
        <td colspan=8 class="parrafo padding10 bordeCompleto"><strong>NOTA: </strong>FAVOR FACTURAR ORIGINAL Y DOS COPIAS, E INCLUIR
                ...
                DOCUMENTOS DE EMBARQUE Y CORRESPONDENCIA DEBE MOSTRAR EL NUMERO DE ESTAR ORDEN DE COMPRA.
        </td>
    </tr>
    ...
    <tr style="text-align:center;">
        <td colspan=4 class="bordeCompleto"><strong>DEPTO. COMPRAS</strong></td>
        <td colspan=2 class="bordeCompleto"><strong>CONTRALORIA</strong></td>
        <td colspan=2 class="bordeCompleto"><strong>GERENCIA GENERAL</strong></td>
    </tr>
    </table>
    </br>
