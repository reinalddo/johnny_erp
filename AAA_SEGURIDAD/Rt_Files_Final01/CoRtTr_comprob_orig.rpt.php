...
function before_group_ID (&$rpt, &$group) {
    ...
    $y-=$flPaso;
    $rpt->putTextWrap( 20, $y, 400, $ilFtSize, strtoupper($group->lastRec['RUC']),  '', 'left', 0, 0);
    $rpt->putTextWrap(200, $y, 650, $ilFtSize, strtoupper($group->lastRec['DIR']),  '', 'left', 0, 0);

    $y-=$flPaso;
    $rpt->putTextWrap( 20, $y, 400, $ilFtSize, strtoupper($group->lastRec['FAC']),  '', 'left', 0, 0);
    ...
    if ($group->lastRec['MIB'] >0 ) {
	    $rpt->putTextWrap($flC1, $y, 250, $ilFtSize, strtoupper($group->lastRec['TIP']),  '', 'left', 0, 0);
...
//	    $rpt->putTextWrap($flC3, $y, 200, $ilFtSize, strtoupper($group->lastRec['DIB']),  '', 'left', 0, 0);
	    ...
	    $rpt->putTextWrap($flC5, $y, 30, $ilFtSize, strtoupper($group->lastRec['MIB']),  '', 'right', 0, 0);
    }
    $y-=$flPaso;
...
//	    $rpt->putTextWrap($flC1, $y, 250,  $ilFtSize, strtoupper($group->lastRec['TIR']),  '', 'left', 0, 0);
	    ...
	    $rpt->putTextWrap($flC3, $y, 250,  $ilFtSize, 'RENTA / ' . strtoupper($group->lastRec['DIR_']),  '', 'left', 0, 0);
