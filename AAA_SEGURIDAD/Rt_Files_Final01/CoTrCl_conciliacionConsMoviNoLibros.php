<?php
/** 
*   Grid para presentar datos de movimientos de bancos en un rango de fechas que no esten en ninguna conciliacion.
...
if (fGetParam("init", false) != false) {
	...
	and com_FecContab between '".fGetParam("fecIni", '2020-12-31')."' and '".fGetParam("fecFin", '2020-12-31')."'
        and (det_EstLibros=0 or (det_EstLibros=1 and com_Concepto like 'ANULA%'))
         AND {filter}
	order by {sort} {dir}
        LIMIT {start}, {limit}";
    ...
    class clsQueryGrid extends clsQueryToJson {
        ...
        function beforeGetData(){
            ...
            $goGrid->setFieldOpt('com_RegNumero', array("header"=>"Numero Reg", "hidden"=>1,"width"=>10));
