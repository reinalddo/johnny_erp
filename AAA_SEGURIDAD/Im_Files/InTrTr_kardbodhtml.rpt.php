<?php
/*
 *	@rev	fah  25/11/09	Correccion de Query: No inluia ciertos registros de detalle, porque habia un GROUP BY. Se elimino.
 **/
...
$tplFile = 'InTrTr_kardbodhtml.tpl';
