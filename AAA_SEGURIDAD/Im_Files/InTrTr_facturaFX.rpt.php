<?php
/*    Factura del Exterior en HTML parte de copia de 
...
$sSql = "select com_NumComp,com_FecTrans, com_Receptor, p.per_RUC ruc, com_Concepto, com_FecContab, 
        ...
        det_valunitario det_cosunitario /*det_CosUnitario*/,det_ValTotal ValTotal/*det_CosTotal*/, com_Usuario,
...
if($rs->EOF){
   ...
   $Tpl->assign("agFilas", $filas);
    ...
    if (!$Tpl->is_cached('InTrTr_facturaFX.tpl')) {
            }
    
            $Tpl->display('InTrTr_facturaFX.tpl');
}
?>