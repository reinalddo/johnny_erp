 ...
 *	@created	28/01/2015
 *	@rev		jvl 28/01/15	Soporte de descripciones dinamicas en: Nombre de Comprobante, Tipo de Emisor/Receptor, Codigos de Emisor/Receptor
 *
 *
 **/
session_start();
...
$query_Recordset1 = "SELECT cla_descripcion AS TRADES,
			    ...
			    det_coditem AS CODIT, act_CodAnterior AS CODAT,
			    left(concat(act_descripcion, ' ', act_descripcion1),50) as ITEM,
			    det_candespachada AS CANTI,
			    det_cantequivale AS CANTE,
			    uni_abreviatura AS UNIDA,
			    det_cosunitario AS CUNIT, det_costotal AS COSTO,
...
<div id="apDiv11" >
  <table width="100%" border="0">
    <!--DWLayoutTable-->
    <tr>
      <td height="34" colspan="4" valign="center" class="style2"><div align="center"><?php echo $row_Recordset1['TRADES'] . " # " . $row_Recordset1['COMPR']; ?></div></td> 
      <td width="124" height="34" class="style2">FECHA:  <?php echo $row_Recordset1['FECHA']; ?></td>
      <td width="124" height="34"  class="style2">SEM:  <?php echo $row_Recordset1['REFOP']; ?></td>
      <!-- @fah28/01/09-->
    </tr>

    <tr>
      <td height="32" valign="center" class="style2"><?php echo $row_Recordset1['TXTEMI']; ?>:</td> <!-- @fah28/01/09-->
      <td colspan="2" width="124" valign="center" class="style4"><?php echo $row_Recordset1['BODEG']; ?></td>
	  <td width="134" valign="center" class="style2"><?php echo $row_Recordset1['TXTREC']; ?>:</td> 
	  <td  colspan="2" valign="center" class="style3"><?php echo $row_Recordset1['RECEP']; ?></td>
    <!-- @fah28/01/09-->
    </tr>
    <tr>
      <td height="40" valign="top" class="style2">CONCEPTO:</td>
      <!-- @fah28/01/09-->
      <td  colspan="6" valign="top" class="style4"><?php echo $row_Recordset1['CONCEP']; ?></td>
    </tr>
  ...
  <!--<br /> -->
    <table width="750" border="0" cellpadding="2" cellspacing="0">
      <tr height="20pt">
        <td width="20" class="HEADER_DET" >SEC</td>
        <td width="50" class="HEADER_DET">SMART</td>
        <td width="50" class="HEADER_DET">CODIGO</td>
        <td width="400" class="HEADER_DET">ITEM</td>
        <td width="30" class="HEADER_DET"><div align="center">UNI</div></td>
        <td width="50" class="HEADER_DET"><div align="center">CANTID.</div></td>
        <td width="70" class="HEADER_DET"><div align="center">C.UNITARIO</div></td>
        <td width="90" class="HEADER_DET"><div align="center">C.TOTAL</div></td>
      ...
      <tr>
         ...
         <td class="LINE_DET"><?php print $row_Recordset1['CODAT']; ?></td>
         ...
         <td class="LINE_DET"><div align="right"><?php print number_format($row_Recordset1['CANTE'],2); ?></div>
         <td class="LINE_DET"><div align="right"><?php print number_format($row_Recordset1['CUNIT'],2); ?></div>
         <td class="LINE_DET"><div align="right"><?php print number_format($row_Recordset1['COSTO'],2); ?></div>
      ...
      <tr>
        <td class="style5" colspan="7"><div align="right" class="style2"></div></td>
    ...
    <table width="100%"  border="0" cellpadding="2" cellspacing="0">
      ...
      <tr>
        <td class="HEADER_DET"height="60" valign="bottom" colspan="6"><p><span class="style2">Nombre:</span>___________________________________________ <span class="style2">Placa:</span>_________________ <span class="style2">Veh&iacute;culo Marca:</span>____________________</p></td>
      </tr>
    </table>
