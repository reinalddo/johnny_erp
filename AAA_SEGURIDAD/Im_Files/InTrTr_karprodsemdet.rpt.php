...
function &fDefineQry(&$db, $pQry=false){
   $slSql = "SELECT 
                ...
                if (com_tipocomp = 'LI' and det_cantequivale > 0  , det_valtotal * pro_signo, 0) AS 'VCO',
                if (com_tipocomp = 'LI' and det_cantequivale < 0, det_cantequivale * pro_signo, 0) AS 'PAG',
                if (com_tipocomp = 'LI' and det_cantequivale < 0  , det_valtotal * pro_signo, 0) AS 'VPA',
                (det_cantequivale * pro_signo) AS 'SAL',
                (det_cantequivale * pro_efeacumula) AS 'HIS',
                (det_valtotal * pro_efeacumula) AS 'VHI'
