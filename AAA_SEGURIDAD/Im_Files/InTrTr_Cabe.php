<?php
/*
 *      @rev    JVL 19/DIC/2015    Cabecera de Importacion
...
//Class_Initialize Event @70-7B995C26
    function clsRecordInTrTr_comp()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->com_NumComp = new clsControl(ccsTextBox, "com_NumComp", "Numero de Comprobante", ccsInteger, "", CCGetRequestParam("com_NumComp", $Method));
            ...
            $this->com_FecTrans = new clsControl(ccsTextBox, "com_FecTrans", "Fecha de Pedido", ccsDate, Array("dd", "/", "mmm", "/", "yy"), CCGetRequestParam("com_FecTrans", $Method));
            ...
            $this->com_FecVencim = new clsControl(ccsTextBox, "com_FecVencim", "Fecha de Arribo", ccsDate, Array("dd", "/", "mmm", "/", "yy"), CCGetRequestParam("com_FecVencim", $Method));
    ...
    "FROM genparametros";
            ...
            $this->com_Supervisor = new clsControl(ccsListBox, "com_Supervisor", "Pais de Origen", ccsInteger, "", CCGetRequestParam("com_Supervisor", $Method));
            ...
            $this->com_Supervisor->ds->SQL = "SELECT par_secuencia as per_CodAuxiliar, par_descripcion as per_Nombre FROM genparametros g WHERE par_Clave = 'IMPCI' AND par_Valor4 = 1 ORDER BY par_Descripcion ";
            $this->com_Supervisor->Required = true;
            /**/
            
            
            $this->com_NumRetenc = new clsControl(ccsTextBox, "com_NumRetenc", "Numero de Retencion", ccsInteger, "", CCGetRequestParam("com_NumRetenc", $Method));
            $this->com_NumRetenc->Required = true;
            $this->com_Contenedor = new clsControl(ccsTextBox, "com_Contenedor", "Numero de Orden del proveedor", ccsText, "", CCGetRequestParam("com_Contenedor", $Method));
            $this->com_Contenedor->Required = true;
            $this->com_RefOperat = new clsControl(ccsTextBox, "com_RefOperat", "Semana", ccsInteger, "", CCGetRequestParam("com_RefOperat", $Method));
            $this->com_RefOperat->Required = true;
            $this->com_NumUnit = new clsControl(ccsTextBox, "com_NumUnit", "Numero de Orden de la Empresa", ccsText, "", CCGetRequestParam("com_NumUnit", $Method));
...
"FROM genparametros";
            $this->com_EstProceso->ds->Parameters["expr116"] = 'ESTIMP';
            ...
            $this->com_EstOperacion = new clsControl(ccsListBox, "com_EstOperacion", "Estado de Importacion", ccsInteger, "", CCGetRequestParam("com_EstOperacion", $Method));
...
"FROM genparametros";
            $this->com_EstOperacion->ds->Parameters["expr110"] = 'ESTIMP';
...
//Open Method @70-23DA9141
    function Open()
    {
        ...
        $this->SQL = "SELECT    com_TipoComp, 
                ...
                com_Supervisor, com_Contenedor, com_NumUnit " .
