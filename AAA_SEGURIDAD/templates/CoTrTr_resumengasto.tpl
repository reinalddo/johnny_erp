...
{report_detail}
    <tr><!-- style="border:#000000 solid 1px;">headerrow-->
        <td class="izq bordeIzq bordeDer" >{$smarty.session.g_empr}</td>  
        <td class="izq bordeIzq bordeDer" >{$rec.ANIO}</td>  
	<td nowrap class="izq bordeDer">{$rec.MES}</td>
        <td class="izq bordeDer">{$rec.TIPO}</td>        
        <td class="izq bordeDer">{$rec.AREA|upper}</td>
        <td class="izq bordeDer">{$rec.CENTRO|upper}</td>
        <td class="izq bordeDer">{$rec.CLASE|upper}</td>
