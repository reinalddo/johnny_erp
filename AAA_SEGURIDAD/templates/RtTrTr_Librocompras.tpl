...
{report_detail}
	...
	<td class="coldata" align="center">{$rec.codSustento}</td>
	<td class="colnum">{$rec.sustento}</td>
       <td class="colnum ">{$rec.TIPO_DOC}</td>
       <td class="colnum ">&nbsp;{$rec.establecimiento|str_pad:3:"0":$smarty.const.STR_PAD_LEFT}</td>
		 <td class="colnum ">&nbsp;{$rec.puntoEmision|str_pad:3:"0":$smarty.const.STR_PAD_LEFT}</td>
	    <td class="colnum ">&nbsp;{$rec.secuencial|str_pad:9:"0":$smarty.const.STR_PAD_LEFT}</td>
	<td class="colnum ">{$rec.TC}</td>
	...
	<td class="colnum " style="text-align:right;">{$rec.RET_10|number_format:2}</td>
	<td class="colnum " style="text-align:right;">{$rec.CRT_10}</td>
	...
	{assign var=tot value=$rec.TOTAL_COMPRA-$ret}
        ...
        <td class="colnum ">&nbsp;{$rec.estabRetencion1|str_pad:3:"0":$smarty.const.STR_PAD_LEFT}</td>
	<td class="colnum ">&nbsp;{$rec.puntoEmiRetencion1|str_pad:3:"0":$smarty.const.STR_PAD_LEFT}</td>
	<td class="colnum ">&nbsp;{$rec.secRetencion1|str_pad:9:"0":$smarty.const.STR_PAD_LEFT}</td>
