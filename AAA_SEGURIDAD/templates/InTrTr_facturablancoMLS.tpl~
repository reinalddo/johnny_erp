...
{report_header}
    ...
    <div id = "cuerpo" style="height:12.5cm; border:#FFFFFF solid 1px; margin-top:106pt;">
    <table border=0 cellspacing=0 style="table-layout:fixed; padding-left: 0px; border:#FFFFFF solid 1px; width:860px; height:'8.5cm'" >
	    ...
	    <td colspan=1 style="width:300pt;">&nbsp;</td>
	    <td colspan=1 style="width:60pt; text-align:center;">{$rec.LUGAR}</td>
	    <td colspan=1 class="" style="width:34pt; text-align:center;">{$rec.DIA}</td>
	    <td colspan=1 class="" style="width:34pt; text-align:center;">{$rec.MES}</td>
	    <td colspan=1 class="" style="width:34pt; text-align:right;">{$rec.ANIO}</td>
        </tr>
    </table>
...
{report_footer}
    ...
    <table border=0 cellspacing=0 style="table-layout:fixed; padding-left: 0px; border:#FFFFFF solid 1px; width:800px; height:'8.5cm'; padding-top:13pt;" >
    <tr>
	...
	<td class ="resalta" style="width:90pt"><strong></strong></td>
        <td class="colnum espacioDer der" style="width:95pt">{$sum.VALOR|number_format:2}</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="colnum espacioDer der" style="padding-top:7px;">&nbsp;{$valorTot|number_format:2}{*$sum.VALOR|number_format:2*}</td>
    </tr>
