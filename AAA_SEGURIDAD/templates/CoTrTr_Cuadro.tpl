...
<!--    	    &nbsp;{$rec.establecimiento|str_pad:3:'0':STR_PAD_LEFT}-{$rec.puntoEmision|str_pad:3:'0':STR_PAD_LEFT}-{$rec.secuencial|str_pad:9:'0':STR_PAD_LEFT}    -->
<!--         <td class="colnum ">&nbsp;{$rec.estabretencion1|str_pad:3:'0':STR_PAD_LEFT}-{$rec.puntoEmiRetencion1|str_pad:3:'0':STR_PAD_LEFT}-{$rec.secretencion1|str_pad:9:'0':STR_PAD_LEFT}</td>   -->
...
{report_detail}
  ...
  <tr style="text-align:center; vertical-align:middle;">
	...
	<td class="colnum " >
        ...
        <td class="colnum ">&nbsp;{$rec.estabretencion1|str_pad:3:"0":$smarty.const.STR_PAD_LEFT}-{$rec.puntoEmiRetencion1|str_pad:3:"0":$smarty.const.STR_PAD_LEFT}-{$rec.secretencion1|str_pad:9:"0":$smarty.const.STR_PAD_LEFT}</td>
