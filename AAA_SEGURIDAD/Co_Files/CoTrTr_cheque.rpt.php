...
/*	JVL 3mar2015   case month(com_feccontab)
...
//            $slFecha=  date("F j, Y", fText2Fecha($rs->fields['fecha']));
    ...
    $rpt->putTextWrap(70, $y, 400, 9, strtoupper($sltxt),  $pLead = 0, $pJust = 'left', $pAng = 0, 0);//70
    $rpt->putTextWrap(210, $y, 200, 10, $flValor2,  $pLead = 0, $pJust = 'right', $pAng = 0, 0); //210 Right, 370 Left

    $slCant = strtoupper(num2letras($flValor, false, 2, 2, " ", " /100"));
//    echo $slCant . " " . $gfValor . " " . $flValor ."<br>";
    $y -=  15; //22
    $rpt->putTextWrap(70, $y, 430, 9, $slCant,  $pLead = 0, $pJust = 'left', $pAng = 0, 0); //10
    $y -= 35;
    $rpt->putTextWrap(30, $y, 300, 9, "Guayaquil,  " . $slFecha,  $pLead = 0, $pJust = 'left', $pAng = 0, 0);//10
//    $group->lastRec['NOM'];
    $y = $rpt->pdf->y -30;
...
$gfValor=0;
$rep->run();
$rep->view($rep->title, $rep->saveFile("CHE_GEN_"));
?>
