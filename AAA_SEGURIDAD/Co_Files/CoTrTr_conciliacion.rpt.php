...
$rep = new ezPdfReport($rs, "letter", "portrait", $slFontName, 9,$rs);
$slEmisor = fDBValor($db, "conpersonas", "concat(per_Apellidos, ' ', per_Nombres)", "per_codauxiliar = " .     $slTxt=fGetParam('pAux', "0"));
$rep->title="CONCILIACION BANCARIA  '" . strtoupper($slEmisor) . "' CORTADO A " . $con->con_feccorte; //JVL    $slTxt=fGetParam('pFec', " ");
//$rep->subTitle="-";
