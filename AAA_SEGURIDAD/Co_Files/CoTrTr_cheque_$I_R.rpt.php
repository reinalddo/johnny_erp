...
//            $slFecha=  date("F j, Y", fText2Fecha($rs->fields['fecha']));
    ...
    $rpt->putTextWrap(65, $y, 400, 9, strtoupper($sltxt),  $pLead = 0, $pJust = 'left', $pAng = 0, 0);//10
    $rpt->putTextWrap(205, $y, 200, 10, $flValor2,  $pLead = 0, $pJust = 'right', $pAng = 0, 0); //205 alineacion RIGHT - 355 LEFT

    $slCant = strtoupper(num2letras($flValor, false, 2, 2, " ", " /100"));
//    echo $slCant . " " . $gfValor . " " . $flValor ."<br>";
    $y -=  15; //22
    $rpt->putTextWrap(60, $y, 430, 9, $slCant,  $pLead = 0, $pJust = 'left', $pAng = 0, 0); //10
    $y -= 31;
