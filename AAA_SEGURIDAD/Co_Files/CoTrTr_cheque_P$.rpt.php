...
*   @rev	esl	29/Nov/2012	Formato de Impresion de Cheque para Salcedo - Banco Produbanco
*   @rev	esl	13-dic-2012	Quitar validacion de emisor y auxiliar de banco
*/
...
//            $slFecha=  date("F j, Y", fText2Fecha($rs->fields['fecha']));
    ...
    $rpt->putTextWrap(195, $y, 200, 12, $flValor2,  $pLead = 0, $pJust = 'right', $pAng = 0, 0); //345

    $slCant = strtoupper(num2letras($flValor, false, 2, 2, " ", " /100"));
//    echo $slCant . " " . $gfValor . " " . $flValor ."<br>";
    $y -=  17; //22
    $rpt->putTextWrap(65, $y, 430, 10, $slCant,  $pLead = 0, $pJust = 'left', $pAng = 0, 0); //205
    $y -= 34;
