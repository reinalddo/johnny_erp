...
Ext.onReady(function(){
    ...
    var store = new storeX({
        ...
        groupField: 'nombrcue',        
        sortInfo: {field: 'nombrcue', direction: 'ASC'},
        sortInfoX: {field: 'nombrcue', direction: 'ASC'}, 
        groupOnSort:false ,
        remoteSort: true
    });
    ...
    */
    ...
    this.grid1.store.load({params: {meta: true, start:0, limit:9999, sort:'cuenta', dir:'ASC'}});// @TODO: load method must be applied over a dinamic referenced object, not 'this.grid1' referenced
