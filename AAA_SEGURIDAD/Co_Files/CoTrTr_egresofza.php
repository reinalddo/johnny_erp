...
$qry_rs1 =
  "SELECT com_RegNumero AS 'REG',  
	  ...
	  concat(per_Apellidos, ' ', ifnull(per_Nombres, ' ')) ),                             ' :  ' ), ''), det_Glosa )   AS 'DES',
...
.style2 {font-family: Tahoma, Arial, Helvetica, sans-serif; font-weight: bold; font-size: 9pt; height: 14pt; border:   1 thin black  }
...
.colheader {border-left: 1px thin black; border-right: 1px thin black; border-bottom: 1px thin black; border-bottom: 1px thin black; border-top: 1px thin black;}
-->
</style>
</head>
<script>
...
<table width="22cm">
  <tr>
    <td rowspan=6 style="width:6.4cm; font-size: 9pt">
      <?php echo $r1->TIP . " - " . $r1->COM . "<br>";
	echo "Cheque # " . $r2->CHQ .  "<br>";
	//echo "Benefic.:" . $r1->REC .  "<br>";
	echo "Valor: " . number_format($r2->VAL, 2, "." , ". ");
	/*$fmt = numfmt_create( 'es_EC', NumberFormatter::DECIMAL );
	numfmt_set_pattern($fmt, "****0.00*** ");
	echo "Pattern: ".numfmt_get_pattern($fmt)."\n";
	echo numfmt_format($fmt, 1234567.891234567890000)."\n";*/
	setlocale(LC_MONETARY, 'en_EC');
	$slTexto = strtoupper(num2letras($r2->VAL, false, 2, 2, " Dolares", " ctvs.")) . "****";
	$ilLong = strlen($slTexto);
	//$slTexto = str_pad($slTexto, 95, "*", STR_PAD_RIGHT);
	//$slTexto .= " " . str_pad("", 100, "*", STR_PAD_RIGHT);
      ?>
    </td>
    <td style="width:4.4cm; height: 0.2cm">&nbsp;      	</td>
    <td style="width:15cm;   height: 0.2cm; font-size:10pt"><?php echo $r1->REC;?>     	</td>
    <td style="width:2cm; height: 0.2cm">&nbsp;            	</td>
    <td style="width:7cm;   height: 0.4cm; text-align:right ; vertical-align:top; font-size:12pt; font-weight:bolder">
	<?php echo str_pad(number_format($r2->VAL, 2,'.',',' ), 14,"***", STR_PAD_LEFT) ."*";?>            	</td>
  </tr>
  <tr>
    <td >&nbsp;      	</td>
  ...
  <tr>
  <tr>
    <td colspan=4 style="padding-left: 20pt; font-size:10pt">GUAYAQUIL, <?php echo $r2->FEC;?></td>
  </tr>
</table>
<div style="width:100%; height: 2.5cm">&nbsp;</div>
<p>&nbsp;</p>
  <table width="98%" border="0">
    ...
    <tr>
      ...
      <td ><div align="right"><span class="style4"><?php echo $r1->TIP;?>-<?php echo $r1->COM;?></span></div></td>
    </tr>
    <tr>
  ...
  <table width="96%"  border="1" style="border-collapse: collapse; position:absolute; top:22cm; left:0.3cm; border: 1px thin black; " cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="25px" valign="bottom"><?php echo $r1->USR . ", " . $_SESSION['g_user']. date_format( date(mktime()), "%d %M, %y"); ?>
      </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
