...
*   @rev	esl	31/Oct/2012	Formato de Impresion de Cheque para Baloschi - Banco Guayaquil
*/
...
//            $slFecha=  date("F j, Y", fText2Fecha($rs->fields['fecha']));
    ...
    $rpt->putTextWrap(90, $y, 400, 9, strtoupper($sltxt),  $pLead = 0, $pJust = 'left', $pAng = 0, 0);//10
    $rpt->putTextWrap(370, $y, 200, 10, $flValor2,  $pLead = 0, $pJust = 'left', $pAng = 0, 0); //220 alineacion RIGHT - 370 LEFT

    $slCant = strtoupper(num2letras($flValor, false, 2, 2, " ", " /100"));
//    echo $slCant . " " . $gfValor . " " . $flValor ."<br>";
    $y -=  15; //22
    $rpt->putTextWrap(90, $y, 430, 9, $slCant,  $pLead = 0, $pJust = 'left', $pAng = 0, 0); //10
    $y -= 41;
    $rpt->putTextWrap(46, $y, 300, 9, "Guayaquil,  " . $slFecha,  $pLead = 0, $pJust = 'left', $pAng = 0, 0);//10
//    $group->lastRec['NOM'];
    $y = $rpt->pdf->y -30;
