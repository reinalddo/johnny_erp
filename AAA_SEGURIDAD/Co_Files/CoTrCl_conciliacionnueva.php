...
if (fGetParam("init", false) != false) {
    ...
    $_SESSION[$gsSesVar]= "select com_TipoComp, com_NumComp, com_FecContab, det_ValDebito, det_ValCredito,
        ...
        and com_FecContab BETWEEN (select con_FecCorte from conconciliacion
			where con_CodCuenta='".fGetParam("pCuenta", '0')."' and
                            con_CodAuxiliar=".fGetParam("pAuxil", '0')." and
                            con_FecCorte < '".fGetParam("fecCorte", '2020-12-31')."'
			order by con_FecCorte desc
			limit 0,1) and '".fGetParam("fecCorte", '2020-12-31')."'
        and {filter}  
        GROUP BY 1,2 
    ...
    $loadJSFile = "CoTrCl_conciliacionnueva";
    ...
    class clsQueryGrid extends clsQueryToJson {
        ...
        function beforeGetData(){
            ...
            $goGrid->setFieldOpt('det_FecLibros', array("header"=>"FEC.LIBROS", "hidden"=>0, "width"=>15, "css"=>"background-color:#F2F5A9;"/*,'editor'=>array("xtype"=>"datefield","renderer" => "formatDate")*/));
