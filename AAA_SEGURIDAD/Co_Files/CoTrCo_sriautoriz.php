...
//Class_Initialize Event @2-07AA3EDC
    function clsRecordgenautsri()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->aut_ID = new clsControl(ccsTextBox, "aut_ID", "Numero de Autorizacion", ccsText, "", CCGetRequestParam("aut_ID", $Method));
            $this->aut_AutSri = new clsControl(ccsHidden, "aut_AutSri", "Aut Aut Sri", ccsText, "", CCGetRequestParam("aut_AutSri", $Method));
...
//DataSourceClass_Initialize Event @2-2D8DA1A2
    function clsgenautsriDataSource()
    {
        $this->ErrorBlock = "Record genautsri/Error";
        $this->Initialize();
        $this->aut_ID = new clsField("aut_ID", ccsText, "");
        $this->aut_AutSri = new clsField("aut_AutSri", ccsText, "");
...
//Prepare Method @2-032BD6F2
    function Prepare()
    {
        ...
        $this->wp->AddParameter("1", "urlaut_ID", ccsText, "", "", $this->Parameters["urlaut_ID"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "genautsri.aut_ID", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method
...
//Open Method @2-657C52F0
    function Open()
    {
        ...
        $this->PageSize = 1;
        $this->query($this->OptimizeSQL(CCBuildSQL($this->SQL, $this->Where . " AND aut_idauxiliar = " . $_GET['aut_IdAuxiliar'] , $this->Order)));
...
//Insert Method @2-B7AFF68C
    function Insert()
    {
        ...
        $this->cp["aut_AutSri"] = new clsSQLParameter("urlaut_ID", ccsText, "", "", CCGetFromGet("aut_ID", ""), -1, false, $this->ErrorBlock);
        ...
        $this->cp["aut_ID"] = new clsSQLParameter("urlaut_ID", ccsText, "", "", CCGetFromGet("aut_ID", ""), -1, false, $this->ErrorBlock);
...
//Update Method @2-D294F026
    function Update()
    {
        ...
        $this->cp["aut_AutSri"] = new clsSQLParameter("urlaut_ID", ccsText, "", "", CCGetFromGet("aut_ID", ""), "", false, $this->ErrorBlock);
        $this->cp["aut_RucImprenta"] = new clsSQLParameter("ctrlaut_RucImprenta", ccsText, "", "", $this->aut_RucImprenta->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["aut_FecEmision"] = new clsSQLParameter("ctrlaut_FecEmision", ccsDate, Array("dd", "/", "mmm", "/", "yy"), Array("yyyy", "-", "mm", "-", "dd", " ", "HH", ":", "nn", ":", "ss"), $this->aut_FecEmision->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["aut_FecVigencia"] = new clsSQLParameter("ctrlaut_FecVigencia", ccsDate, Array("dd", "/", "mmm", "/", "yy"), Array("yyyy", "-", "mm", "-", "dd", " ", "HH", ":", "nn", ":", "ss"), $this->aut_FecVigencia->GetValue(), "", false, $this->ErrorBlock);
        ...
        $wp->AddParameter("1", "urlaut_ID", ccsText, "", "", CCGetFromGet("aut_ID", ""), "", false);
        if(!$wp->AllParamsSet()) {
            $this->Errors->addError("");
        }
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildUpdate");
        $wp->Criterion[1] = $wp->Operation(opEqual, "aut_ID", $wp->GetDBValue("1"), $this->ToSQL($wp->GetDBValue("1"), ccsText),false);
        $Where = 
             $wp->Criterion[1];
