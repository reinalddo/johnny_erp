...
//Class_Initialize Event @3-5209E7A5
    function clsRecordperiodos_qry()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->per_Aplicacion->Values = array(array("CO", "PERIODOS CONTABLES"), array("IN", "PERIODOS DE INVENTARIO"), array("LI", "PERIODOS DE LIQUIDACIONES"),array("CC", "CUENTAS POR COBRAR"), array("PR", "PRESUPUESTOS"));
        }
    }
