...
*    @see	 CoAdAu_mant.php
*    @rev	 fah27/02/09	Soporte de Grupos de Ctos de Costo/Gasto, impresion correcta de los grupos
*    @rev	 mvalle 02/Marzo/09 Se incluyo el modo de acceso a la selecccion de la empresa lineas 15,16,17,18
*/
...
function &fDefineQry(&$db, $pQry=false){
    ...
    $slSql = "
		...
		concat(ifnull(s.par_descripcion,'') , ' / ' , ifnull(g.par_descripcion,'')) AS GRU,
