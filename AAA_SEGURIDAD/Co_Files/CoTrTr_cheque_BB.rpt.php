...
*   @rev	esl	31/Oct/2012	Formato de Impresion de Cheque para Baloschi - Banco Bolivariano
*/
...
//            $slFecha=  date("F j, Y", fText2Fecha($rs->fields['fecha']));
    ...
    $rpt->putTextWrap(75, $y, 400, 10, strtoupper($sltxt),  $pLead = 0, $pJust = 'left', $pAng = 0, 0);//210
    $rpt->putTextWrap(220, $y, 200, 12, $flValor2,  $pLead = 0, $pJust = 'right', $pAng = 0, 0); //345

    $slCant = strtoupper(num2letras($flValor, false, 2, 2, " ", " /100"));
//    echo $slCant . " " . $gfValor . " " . $flValor ."<br>";
    $y -=  19; //22
    $rpt->putTextWrap(75, $y, 430, 10, $slCant,  $pLead = 0, $pJust = 'left', $pAng = 0, 0); //205
    $y -= 38;
    $rpt->putTextWrap(30, $y, 300, 10, "Guayaquil,  " . $slFecha,  $pLead = 0, $pJust = 'left', $pAng = 0, 0);//195 
//    $group->lastRec['NOM'];
    $y = $rpt->pdf->y -30;
