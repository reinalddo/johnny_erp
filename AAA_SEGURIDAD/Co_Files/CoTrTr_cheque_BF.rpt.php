...
*   @rev	esl	27/Jul/2012	Formato de Impresion de Cheque para Asisbane Banco Nacional de Fomento
*/
...
//            $slFecha=  date("F j, Y", fText2Fecha($rs->fields['fecha']));
    ...
    $rpt->putTextWrap(65, $y, 400, 10, strtoupper($sltxt),  $pLead = 0, $pJust = 'left', $pAng = 0, 0);//210
