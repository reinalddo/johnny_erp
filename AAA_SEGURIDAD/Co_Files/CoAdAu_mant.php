...
"FROM genparametros";
            ...
            $this->per_CodAuxiliar = new clsControl(ccsTextBox, "per_CodAuxiliar", "C�digo de Auxiliar", ccsText, "", CCGetRequestParam("per_CodAuxiliar", $Method));
...
"FROM genparametros";
            ...
            $this->per_ParteRelacionada = new clsControl(ccsListBox, "per_ParteRelacionada", "Per Parte Relacionada", ccsText, "", CCGetRequestParam("per_ParteRelacionada", $Method));
            $this->per_ParteRelacionada->DSType = dsListOfValues;
            $this->per_ParteRelacionada->Values = array(array("NO", "NO"), array("SI", "SI"));
            $this->per_ParteRelacionada->Required = true;
...
//Validate Method @212-0533B744
    function Validate()
    {
        ...
        if(CCDLookUp("COUNT(*)", "conpersonas", "per_CodAuxiliar=" . $this->ds->ToSQL($this->ds->per_CodAuxiliar->GetDBValue(), $this->ds->per_CodAuxiliar->DataType) . $Where, $DBdatos) > 0)
            $this->per_CodAuxiliar->Errors->addError("El campo C�digo de Auxiliar ya existe.");
        ...
        $Validation = ($this->per_ParteRelacionada->Validate() && $Validation);        
...
//CheckErrors Method @212-08C47C61
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->per_ParteRelacionada->Errors->Count());
...
//InsertRow Method @212-8A85A5DD
    function InsertRow()
    {
        ...
        $this->ds->per_ParteRelacionada->SetValue($this->per_ParteRelacionada->GetValue());
...
//Show Method @212-3B4A2C59
    function Show()
    {
        ...
        $this->per_ParteRelacionada->Prepare();
            ...
            if($this->Errors->Count() == 0)
            {
                ...
                else if($this->ds->next_record())
                {
                    ...
                    if(!$this->FormSubmitted)
                    {
                        ...
                        $this->per_ParteRelacionada->SetValue($this->ds->per_ParteRelacionada->GetValue());
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error .= $this->per_ParteRelacionada->Errors->ToString();
	...
	global $gsModulId;
        ...
        $this->per_ParteRelacionada->Show();
...
//Class_Initialize Event @212-23022BBE
    function clsCoAdAu_mantDataSource()
    {
        ...
        $this->per_ParteRelacionada = new clsField("per_ParteRelacionada", ccsText, "");
...
//SetValues Method @212-7461769A
    function SetValues()
    {
        ...
        $this->per_ParteRelacionada->SetDBValue(trim($this->f("per_ParteRelacionada")));
...
//Insert Method @212-C081524A
    function Insert()
    {
        ...
        $this->cp["per_ParteRelacionada"] = new clsSQLParameter("ctrlper_ParteRelacionada", ccsText, "", "", $this->per_ParteRelacionada->GetValue(), "", false, $this->ErrorBlock);
        ...
        $this->SQL = "INSERT INTO conpersonas ("
             ...
             . $this->ToSQL($this->cp["per_ParteRelacionada"]->GetDBValue(), $this->cp["per_ParteRelacionada"]->DataType)
             . ")";
...
//Update Method @212-0001C461
    function Update()
    {
        ...
        $this->SQL = "UPDATE conpersonas SET "
             ...
             . "per_ParteRelacionada=" . $this->ToSQL($this->per_ParteRelacionada->GetDBValue(), $this->per_ParteRelacionada->DataType);
