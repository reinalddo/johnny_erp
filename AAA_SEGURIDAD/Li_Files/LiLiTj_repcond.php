...
//Include Page implementation @59-49BEB8FC
...
//Class_Initialize Event @2-9C852CD6
    function clsRecordliqembarquesSearch()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->emb_CodBuque = new clsControl(ccsListBox, "emb_CodBuque", "emb_CodBuque", ccsInteger, "", CCGetRequestParam("emb_CodBuque", $Method));
...
"FROM genparametros";
            ...
            $this->tad_CodMarca->ds->wp->Criterion[2] = $this->tad_CodMarca->ds->wp->Operation(opEqual, "par_Valor1", $this->tad_CodMarca->ds->wp->GetDBValue("2"), $this->tad_CodMarca->ds->ToSQL($this->tad_CodMarca->ds->wp->GetDBValue("2"), ccsText),false);
            ...
            $this->tad_CodEmpaque = new clsControl(ccsListBox, "tad_CodEmpaque", "tad_CodEmpaque", ccsText, "", CCGetRequestParam("tad_CodEmpaque", $Method));
...
//Validate Method @2-675A532D
    function Validate()
    {
        ...
        $Validation = ($this->tad_CodEmpaque->Validate() && $Validation);
...
//CheckErrors Method @2-2ACB9409
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->tad_CodEmpaque->Errors->Count());
...
//Operation Method @2-98CE5230
    function Operation()
    {
        ...
        $Redirect = "LiLiTj_repcond.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                if(!CCGetEvent($this->Button_DoSearch->CCSEvents, "OnClick")) {
                    $Redirect = "";
                } else {
                    $Redirect = "LiLiTj_repcond.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", Array("Button_DoSearch")));
                }
            }
        } else {
            $Redirect = "";
...
//Show Method @2-577731DE
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error .= $this->tad_CodEmpaque->Errors->ToString();
...
$FileName = "LiLiTj_repcond.php";
$Redirect = "";
$TemplateFileName = "LiLiTj_repcond.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page
