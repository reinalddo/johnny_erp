...
switch ($ilEstadoProc) {
    ...
    case 6:
        ...
        $agPla['CXP'] = NZ(fDBValor($db, 'genparametros', 'par_valor1', "par_clave='CUCXPP'"), false); //(strlen($rec->PRO_CODCUENTA1) >  1) ? $rec->PRO_CODCUENTA1 : "201030102" ; // Genparametros CUCXPP
        $agPla['CXL'] = NZ(fDBValor($db, 'genparametros', 'par_valor1', "par_clave='CUCXL'"), false); //(strlen($rec->PRO_CODCUENTA2) >  1) ? $rec->PRO_CODCUENTA1 : "201030104" ; // Genparametros CUCXL
        $agPla['CXC'] = NZ(fDBValor($db, 'genparametros', 'par_valor1', "par_clave='CUCXCP'"), false); //(strlen($rec->PRO_CODCUENTA3) >  1) ? $rec->PRO_CODCUENTA1 : "10030699" ; // Genparametros CUCXCP
        $agPla['ACI'] = "";
        $agPla['CAP'] = "";
        $agPla['TAP'] = "";
        $agPla['AAP'] = "";
