<?php
/*
*   LiLiRp_anexo_mod.rpt.php: Anexo de Inventario, incluyendo saldos por cobrar
...
function &fDefineQry(&$db, $pQry=false){
    ...
    $alSql[] =  "CREATE TEMPORARY TABLE tmp_data
              ...
              GROUP BY 1,2,3,4,5  
              HAVING SUM(det_CantEquivale * pro_Signo) > 0 ORDER BY 1,2,3 ";
...
if (fGetParam('pTipo', 'XX') == 'H') { //      Formato que incluye 'historia' del productos, saldo anterior y final
    $rep->colHead = array(
                    'DIT'=>'   ITEM ',
                    'C01'=>'SALDO ANTER.',
//                    'V01'=>'VAL ANT',
...
//if (fGetParam('pTipo', 'XX') == 'H') { //      Formato que incluye 'historia' del productos, saldo anterior y final
    ...
    echo " HISTORICO  ";
/*//    }
// else { //                                       Formato para el productor, sin saldos, con detalle de cobros y pagos
