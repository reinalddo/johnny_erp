 ...
 *
 * @rev	fah		15/04/2011		added beforeNext and beforePrevious Events
 * @constructor
...
this.showLoadMask(true, 'validating');
    ...
    initComponent : function()
    {
        ...
        this.addEvents(
            ...
            /**
             * @event beforeNext
             * Fires before  the Next-button proccessing takes place
             * @param {Ext.ux.Wiz} this
             */
            ,'beforeNext'                       //#fah15/04/2011
            /**
             * @event beforePrevious
             * Fires before  the Previous-button proccessing takes place
             * @param {Ext.ux.Wiz} this
             */
            ,'beforePrevious'                   //#fah15/04/2011
        );
...
// -------- helper
    ...
    /**
     * #fah19/04/2011
     * Returns the current card-data in this wizard. the values are objects containing key/value pairs in the form of
     * fieldName : fieldValue.
     *
     * @param {int} pIdx    Index of card to get data
     * @return {Array}
     */
    getCardData : function(pIdx)
    {
        if(!pIdx) pIdx = this.currentCard;
        if (this.cards[pIdx].form) {
            return this.cards[pIdx].form.getValues(false);
        } else {
            return {};
        }
    },
    ...
    initEvents : function()
    {
        ...
        this.on('beforenext',       this.onBeforeNext, this);       //#fah15/04/2011
        this.on('beforeprevious',   this.onBeforePrevious, this);   //#fah15/04/2011
    ...
    initPanels : function()
    {
        ...
        for (var i = 0, len = cards.length; i < len; i++) {
            ...
            cards[i].on('beforeNext', this.onBeforeNext, this);             //#fah15/04/2011
            cards[i].on('beforePrevious', this.onBeforePrevious, this);     //#fah15/04/2011
        }
...
// -------- listeners
    ...
    /**
     * Listener for the BeforeNext event.
     * @param
     *
     * @return {Boolean}
     */
    onBeforeNext : function(panel)
    {
        ...
        /**
     * Listener for the beforeprevious event.
     *
     * @param
     *
     * @return {Boolean}
     */
    ,onBeforePrevious : function(panel)
    {
        return this.closable;
    }
    /**
    ...
    {
        if (this.fireEvent('beforePrevious', this, this.getCardData()) !== false) {       //#fah15/04/2011
    ...
    {
        if (this.fireEvent('beforeNext', this, this.getCardData()) !== false) {       //#fah15/04/2011
