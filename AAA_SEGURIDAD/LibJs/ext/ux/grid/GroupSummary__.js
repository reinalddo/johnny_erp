 ...
 * licensing@extjs.com
 * @rev: @fah:23/03/08   No funciona arroja error al redimencionar Cabeceras de columna
...
Ext.extend(Ext.grid.GroupSummary, Ext.util.Observable, {
    ...
    doAllWidths : function(ws, tw){
        ...
        for(var i = 0, len = gs.length; i < len; i++){
            //s = gs[i].childNodes[2]; // @fah:23/03/08   No funciona arroja error
            s = gs[i].childNodes[0]; // @fah:23/03/08
            s.style.width = tw;
            s.firstChild.style.width = tw;
