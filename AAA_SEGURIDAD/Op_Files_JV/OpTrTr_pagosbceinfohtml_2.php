...
//	$goGrid = new baaGrid ($gsSqlText, DB_MYSQL);
	...
	$goGrid->setWidth( 0, 20);
	$goGrid->setWidth( 1, 200);
	$goGrid->setWidth( 2, 100);
    $goGrid->setWidth( 3, 40);
    $goGrid->setWidth( 4, 40);
    $goGrid->setWidth( 5, 60);
    $goGrid->setWidth( 6, 60);
    $goGrid->setWidth( 7, 60);
    $goGrid->setWidth( 8, 60);
    $goGrid->setWidth( 9, 40);
    $goGrid->setWidth( 10, 70);
    $goGrid->setWidth( 11, 60);
    $goGrid->setWidth( 12, 60);
    $goGrid->setWidth( 13, 40);
