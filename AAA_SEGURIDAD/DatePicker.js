//JS DatePicker @0-EEEE0413

// Date formatting functions begin ---------------------------------------------------


var listMonths = new Array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
var listShortMonths = new Array("Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic");
var firstWeekDay = "Dom";
var listWeekdays = new Array("Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado");
var listShortWeekdays = new Array("Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab");
...
function buildDatePickerParts()
{
  ...
  DatePickerEnd +=
      ...
      (isNav?"":"<FORM NAME='calTable' onSubmit='return false;'>") +
      "<TD>" +
      "<INPUT TYPE='button' CLASS='CalendarButtons' NAME='today' VALUE='Hoy' onClick=\"parent.opener.setToday()\">" + 
      "</TD>" + 
      (isNav?"":"</FORM>")+
      "</TABLE>" +
      (isNav?"</FORM>":"")+
