...
{report_header}
    ...
    <div id = "cuerpo" style="height:6.5cm; border:#FFFFFF solid 1px; margin-top:118pt;">
    <!-- ********************************** C A B E C E R A ***********************************-->  
...
{report_footer}
    ...
    <!-- ********************************** SUMATORIA ***********************************-->  
   <table border=0 cellspacing=0 style="table-layout:fixed; padding-left: 0px; padding-top:5pt; border:#FFFFFF solid 1px; width:800px; height:'8.5cm'" >    
