...
* @rev		fah 28/12/2014	Corerccion de consulta de fecha minima de contabilizacion en parametro DIMIN y no DIMINI
* 				
*/
...
/* fah 05/02/09   Validacion de Fecha de Inicio de Contabilizacion DIMM*/
    ...
    $slCond = "par_clave='DIMINI' AND par_valor1 > '" . $cla->fechaRegistro . "'";      // #fah 28/12/2014  antes apuntaba a parametro DIMINI y comparaba por <=
    $ilFlag = fDBValor($db, "genparametros", "par_valor1 <= '" . $cla->fechaRegistro . "'", $slCond);
    if ($ilFlag >=1) exit;
	fDbgContab("Paso 1b " . $sqltext);
