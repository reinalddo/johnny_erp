...
$sSql = "SELECT ID,
	...
	if(porcentajeAir = 0, valRetAir, 0)  as 'RET_0',
	IF(porcentajeAir = 1, valRetAir, 0)  AS 'RET_1',
	IF(porcentajeAir2 = 1, valRetAir2, 0) AS 'RET_11',
	IF(porcentajeAir3 = 1, valRetAir3, 0) AS 'RET_12',
	...
	if(porcentajeAir = 25, valRetAir, 0) + if(porcentajeAir2 = 25, valRetAir2, 0) + if(porcentajeAir3 = 25, valRetAir3, 0) as 'RET_25',
	 ...
	 concat(if(porcentajeAir = 0, codRetAir, '') ) as 'CRT_0',
	 CONCAT(IF(porcentajeAir = 1, codRetAir, '') ) AS 'CRT_1', 
	 CONCAT(IF(porcentajeAir2 = 1, codRetAir2, '')) AS 'CRT_11', 
	 CONCAT(IF(porcentajeAir3 = 1, codRetAir3, '')) AS 'CRT_12', 
	...
	WHERE tipoTransac IN (1,8) and YEAR(com_feccontab) = " . $anio . " and MONTH(com_FecContab) = " . $mes. " ORDER BY estabRetencion1,puntoEmiRetencion1,secRetencion1";
