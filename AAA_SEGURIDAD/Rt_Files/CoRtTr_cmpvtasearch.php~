...
//Class_Initialize Event @125-D4281F9D
    function clsRecordfiscomprasSearch()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->s_secuencial = new clsControl(ccsTextBox, "s_secuencial", "s_secuencial", ccsInteger, "", CCGetRequestParam("s_secuencial", $Method));
...
//Class_Initialize Event @3-5145722C
    function clsGridfiscompras()
    {
        ...
        $this->secuencial = new clsControl(ccsLabel, "secuencial", "secuencial", ccsInteger, Array(True, 0, "", "", False, Array("0", "0", "0", "0", "0", "0", "0"), "", 1, True, ""), CCGetRequestParam("secuencial", ccsGet));
