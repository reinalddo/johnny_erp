...
//Class_Initialize Event @3-5145722C
    function clsGridfiscompras()
    {
        ...
        $this->baseNoGraIva = new clsControl(ccsLabel, "baseNoGraIva", "baseNoGraIva", ccsFloat, Array(True, 2, ".", "", False, Array("#", "#", "#"), Array("#", "#"), 1, True, ""), CCGetRequestParam("baseNoGraIva", ccsGet));
        $this->baseImpExe = new clsControl(ccsLabel, "baseImpExe", "baseImpExe", ccsFloat, Array(True, 2, ".", "", False, Array("#", "#", "#"), Array("#", "#"), 1, True, ""), CCGetRequestParam("baseImpExe", ccsGet));
...
//GetErrors Method @3-AF4EB948
    function GetErrors()
    {
        ...
        $errors .= $this->baseNoGraIva->Errors->ToString();
        $errors .= $this->baseImpExe->Errors->ToString();
