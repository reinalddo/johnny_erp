...
Rico.LiveGridMethods.prototype = {
  ...
  remainingHt: function() {
    ...
    switch (this.sizeTo) {
      ...
      case 'body':
        var bodyHt=document.height || document.body.offsetHeight;
        var remHt=winHt-bodyHt-this.options.scrollBarWidth-margin;
  ...
  adjustPageSize: function() {
    ...
    Rico.writeDebugMsg('adjustPageSize lastRow='+this.lastRowPos);
  ...
  autoRemoveRows: function(overage) {
    ...
    Rico.writeDebugMsg("autoRemoveRows overage="+overage+" cnt="+removeCnt);
