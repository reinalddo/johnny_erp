...
var Rico = {
  ...
  init : function() {
    ...
    for (var i=0; i<elements.length; i++) {
      ...
      if (filename == 'rico.js') {
        ...
        this.htmDir= path.replace(/js\/$/,'xml/');
  ...
  moduleDependencies : {
    ...
    Calendar   : ['ricoCalendar.js', 'css/ricoCalendar.css'],
    Tree       : ['ricoTree.js', 'css/ricoTree.css'],
    SimpleGrid : ['ricoCommon.js', 'ricoSimpleGrid.js', 'css/ricoGrid.css'],
    LiveGrid   : ['ricoSimpleGrid.js', 'ricoLiveGrid.js', 'css/ricoGrid.css'],
    CustomMenu : ['css/ricoMenu.css'],
    LiveGridMenu : ['ricoLiveGridMenu.js', 'css/ricoMenu.css'],
    LiveGridAjax : ['ricoSimpleGrid.js', 'ricoLiveGrid.js', 'ricoLiveGridAjax.js', 'css/ricoGrid.css'],
    LiveGridForms: ['ricoSimpleGrid.js', 'ricoLiveGrid.js', 'ricoLiveGridAjax.js', 'ricoLiveGridMenu.js',
					'css/ricoMenu.css', 'ricoLiveGridForms.js', 'ricoEffects.js', 'css/ricoGrid.css',
					'css/ricoLiveGridForms.css']
  },
