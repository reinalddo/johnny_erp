...
* @rev    Ene-10-08     Agregar opciones de Estadisticas de Compras, por a�o
* @rev    25-08-09    fah Corregir rutra de nuevo panel Anexos
* @rev	  30-oct-2012 esl ocultar opcion 
*/
...
var PathAAA = window.location.protocol + "//" + window.location.host + "/AAA/";
...
var Base3 = window.location.protocol + "//" + window.location.host + "/AAA/AAA_7_2/";
...
with (pMenu)
{
	...
	startMenu('mCo', true, 0, 22, 150, subM);
	    ...
	    addItem('Anexo Transac (*)',       		'mAt2',             'sm:');
	    addItem('Administracion',       		'CoAd',             'sm:');
	    addItem('Estados Financieros',  		'CoEf',             'sm:');
	    addItem('Reportes',             		'mCoRe',           'sm:');
	    addItem('Presupuesto',             		'mCoPre',           'sm:');

        startMenu('CoTr', true, 90, 10, 170, subM);
            addItem('Ingreso de Comprobantes',      Base + 'In_Files/InTrTr_Cabe.php?pMod=CO&pAplic=CO',     '');
            addItem('Consulta de Comprobantes',     Base + 'In_Files/InTrTr.php?pMod=CO',          '');
	    ...
	    addItem('Bitacora de Documentos',      Base + '../AAA_5/Bi_Files/BiTrTr_bitacoraIngresoDoc.php',          '');

    	startMenu('CoAd', true, 90, 10, 170, subM);
    	    addItem('Plan de Cuentas',              Base + 'Co_Files/CoAdCu_top.php',          '');
	    addItem('Regenerar Plan de Cuentas',    Base + 'Co_Files/CoAdCu_Regenera.php',          '');
...
*/
            ...
            addItem('Cierre de Balance', 			'/AAA/sinlo/AAA_5/Co_Files/CoTrTr_cierreper.php',             '');
	    ...
	    addItem('Cuentas por Pagar',      Base + 'Co_Files/CoTrTr_condCuadro.php',     '');
	 ...
	 startMenu('mCoPre', true, 90, 10, 170, subM);
            addItem('Panel de Presupuesto ',      		Base + '../AAA_7/Pr_Files/PrTrTr_presupuesto.php',     '');
	    ...
	    addItem('Daus y Anulados',                 	Base + 'Rt_Files/CoRtTr_archxml_panel.php',          '');
	    addItem('Nuevo Panel',                 	PathAAA + 'AAA_5/Rt_Files/CoRtTr_panelAnexos.php',          '');

	startMenu('mAt2', true, 90, 10, 170, subM);
 	    addItem('Consulta',              	     	Base + 'Rt_Files/CoRtTr_cmpvtasearch.php',          '');
    	addItem('Reportes',                 	Base + 'Rt_Files/CoRtTr_condmov.php',          '');
	    addItem('Nuevo Panel',                 	PathAAA + 'AAA_5/Rt_Files/CoRtTr_panelAnexos.php',          '');
	...
	startMenu('mBa', true, 0, 22, 150, subM);
	    ...
	    addItem('Caja',        		'BaCj',             'sm:');
	    addItem('Conciliacion',             	Base + 'Co_Files/CoTrCl_search.php',             '');
	    addItem('Nuevo Panel Conciliacion',         '../AAA_5/Co_Files/CoTrCl_panelConciliacion.php',             '');
	...
	startMenu('BaCj', true, 90, 10, 170, subM);
    	    addItem('Caja / Banco',     Base + '../AAA_5/work_w_abr_01/CoTrTr_caja.php',          '');
	    addItem('Panel Cheques',     Base + '../AAA_5/Co_Files/CoTrTr_panelcheques.php',          '');
	    addItem('Reimpresion',        		'CjRP',                 'sm:');

	startMenu('CjRP', true, 90, 10, 170, subM);
    	    addItem('Comprobante Simple',      Base + '../AAA_5/Co_Files/CoTrTr_egresofzasimple.php?pQry=com_RegNumero=',     '');
    	    addItem('Boucher',     Base + '../AAA_5/Co_Files/CoTrTr_egresofza.php?pQry=com_RegNumero=',          '');
	    addItem('Cheque',     Base + '../AAA_5/Co_Files/CoTrTr_chequefza.php?pQry=com_RegNumero=',          '');

    	startMenu('BaRe', true, 90, 10, 170, subM);
      	    addItem('Saldos Diarios',         		Base + 'Co_Files/CoTrTr_saldiario.rpt.php',       '');
    	    //addItem('Conciliacion',         		'alert("Pendiente");',              'js:'); @rev esl 30-oct-2012 ocultar opcion 
    	    //addItem('lIBRO bANCOS',         		'alert("Pendiente");',              'js:'); @rev esl 30-oct-2012 ocultar opcion 
	...
	startMenu('mIn', true, 0, 22, 150, subM);
	    ...
	    addItem('Procesos',     			Base + 'In_Files/InAdPr_ejec.phtml?','');
	    addItem('Reportes',             		Base + 'In_Files/InTrTr_condmov.php',              '');
	    addItem('Enlace OC',             		PathAAA + 'AAA_5/work_w_abr_01/CoTrTr_panelvinculardoc.php',              '');
	    addItem('Estadisticas de IB',             	'InEsI',                 'sm:');
	    addItem('Estadisticas de OC',             	'InEsC',                 'sm:');

    	startMenu('InTr', true, 90, 10, 150, subM);
    	    addItem('Ingreso / Modificaci�n',       Base + 'In_Files/InTrTr_Cabe.php?pMod=IN&pAplic=IN',                 '');
    	    addItem('Consulta',                     Base + 'In_Files/InTrTr.php?pMod=IN&',                      '');

    	startMenu('InAd', true, 90, 10, 150, subM);
    	    addItem('Items',                        Base + 'Co_Files/CoAdAc_mant2.php',                 '');
	...
	startMenu('mEm', true, 0, 22, 150, subM);
	    ...
	    addItem('Ingreso de Tarja',             Base3 + 'Li_Files/LiEmTj_panelTarjas.php',             '');
	    addItem('Reportes Generales',       	'mTjRe',              'sm:');
	    addItem('Operaciones',             		Base2 + 'Op_Files/OpTrTr_panelop.php',              '');
	    addItem('Prestamos y Anticipos',        Base + '../AAA_5/Co_Files/CoAdFi_formTable.php',          '');
	    ...
	    startMenu('mEmAd', true, 90, 10, 200, subM);
	        ...
	        addItem('Auxiliares (Activos y Otros)', Base + 'Co_Files/CoAdAc_mant2.php',             '');
	...
	startMenu('mLi', true, 0, 22, 150, subM);
	    ...
	    addItem('Emisi�n de Documentos',        'mLiDo',              'sm:');
	    addItem('Consultas',       	            'mLiCo',              'sm:');

    	startMenu('mLiAd', true, 90, 10, 150, subM);
	        addItem('Variables de C�lculo',             Base + 'Li_Files/LiAdVa_search.php',   '');
	        addItem('Rubros de Liquidaci�n',            Base + 'Li_Files/LiAdRu_search.php',   '');
    	...
    	startMenu('mLiPr', true, 90, 10, 150, subM);
	        ...
	        addItem('Lotes de Liquidaci�n',             Base + 'Li_Files/LiLiPr_search.php',   '');
	        addItem('Liquidaciones',                    Base + 'Li_Files/LiLiLi_search.php',   '');
        	addItem('Emisi�n de Docs',                  Base + 'Li_Files/LiLiLo_search.php',   '');
		addItem('Consolidacion de Tarjas',         '../AAA_5/Op_Files/OpTrTr_consolida.php',             '');
		addItem('Ingreso de Descuentos',         '../AAA_5/work_w_abr_01/LiLiLi_panelLiquidaRubro.php?',             '');
		addItem('Rol y Consumo',         Base +'Li_Files/LiLiPr_contabrol_cond.php?',             '');
	...
	startMenu('mSe', true, 0, 22, 150, subM);
	    ...
	    addItem('M�dulos',              		Base + 'Se_Files/SeGeMo_top.php', '');
