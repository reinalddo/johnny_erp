...
//Variables @2-25F51C69
    ...
    var $Sorter_pro_periodo;
    var $Sorter_pro_cuenta;
    var $Sorter_pro_auxiliar;
    var $Sorter_pro_nivel;
	var $Sorter_pro_cantidad;
	var $Sorter_pro_valor;
//End Variables
...
//Class_Initialize Event @2-F9022B60
    function clsGridSeGeUs_qry()
    {
        ...
        $this->Link1->Page = "ProPre_mant.php";
    }
