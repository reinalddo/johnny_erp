...
while ($r = $rs->fetchRow())
    {
echo "<DIV STYLE='POSITION:absolute; LEFT:75px; TOP:".$igcabvert_l1."px;'>Sr.(es)</DIV>";
...
echo "<DIV STYLE='POSITION:absolute; LEFT:".$igcabvert_lizT."px; TOP:".$igcabvert_l1."px;'>Fecha de Emision</DIV>";
echo "<DIV STYLE='POSITION:absolute; LEFT:75px; TOP:".$igcabvert_l2."px;'>RUC/CI:</DIV>";
...
echo "<DIV STYLE='WIDTH:400px; font-size: 14px; POSITION:absolute; LEFT:".$igcabvert_lizT."px; TOP:".$igcabvert_l2."px;'>Tipo de Comprobante de Venta</DIV>";
echo "<DIV STYLE='POSITION:absolute; LEFT:75px; TOP:".$igcabvert_l3."px;'>Direccion:</DIV>";
echo "<DIV STYLE='POSITION:absolute; LEFT:195px; TOP:".$igcabvert_l3."px;'>".$r['Direcc']."</DIV>";
echo "<DIV STYLE='WIDTH:400px; font-size: 14px; POSITION:absolute; LEFT:".$igcabvert_lizT."px; TOP:".$igcabvert_l3."px;'>Nº de Comprobante de Venta</DIV>";
echo "<DIV STYLE='WIDTH:200px; POSITION:absolute; LEFT:".$igcabvert_liz."px; TOP:".$igcabvert_l3."px;'>".$r['FAC']."</DIV>";


	if($r['MIB']>0)
	{
	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_1."px;  TOP:".$igVertPos."px;'>".$r['PER']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_2."px; TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['BIB']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_3."px; TOP:".$igVertPos."px;'>IVA</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_4."px; TOP:".$igVertPos."px;'>".$r['TIB']."</DIV>";
   	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_5."px; TOP:".$igVertPos."px; text-align:right; width:60px;'>".$r['PIB']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_6."px;TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['MIB']."</DIV>";
	$igVertPos +=  $igPaso;
	}
	if($r['MIS']>0)
	{
	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_1."px;  TOP:".$igVertPos."px;'>".$r['PER']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_2."px; TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['BIS']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_3."px; TOP:".$igVertPos."px;'>IVA</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_4."px; TOP:".$igVertPos."px;'>".$r['TIS']."</DIV>";
   	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_5."px; TOP:".$igVertPos."px; text-align:right; width:60px;'>".$r['PIS']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_6."px; TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['MIS']."</DIV>";
	$igVertPos +=  $igPaso;
	}
	...
	{
	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_1."px;  TOP:".$igVertPos."px;'>".$r['PER']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_2."px; TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['BIR']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_3."px; TOP:".$igVertPos."px;'>RENTA</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_4."px; TOP:".$igVertPos."px;'>".$r['TIR']."</DIV>";
   	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_5."px; TOP:".$igVertPos."px; text-align:right; width:60px;'>".$r['PIR']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_6."px; TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['MIR']."</DIV>";
	$igVertPos +=  $igPaso;
	}
	...
	{
	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_1."px;  TOP:".$igVertPos."px;'>".$r['PER']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_2."px; TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['BIR2']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_3."px; TOP:".$igVertPos."px;'>RENTA</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_4."px; TOP:".$igVertPos."px;'>".$r['TIR2']."</DIV>";
   	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_5."px; TOP:".$igVertPos."px; text-align:right; width:60px;'>".$r['PIR2']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_6."px; TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['MIR2']."</DIV>";
	$igVertPos +=  $igPaso;
	}
	...
	{
	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_1."px;  TOP:".$igVertPos."px;'>".$r['PER']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_2."px; TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['BIR3']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_3."px; TOP:".$igVertPos."px;'>RENTA</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_4."px; TOP:".$igVertPos."px;'>".$r['TIR3']."</DIV>";
   	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_5."px; TOP:".$igVertPos."px; text-align:right; width:60px;'>".$r['PIR3']."</DIV>";
  	echo "<DIV STYLE='POSITION:absolute; LEFT:".$izqdet_6."px; TOP:".$igVertPos."px; text-align:right; width:50px;'>".$r['MIR3']."</DIV>";
	$igVertPos +=  $igPaso;
	}
	
	
  	$total=$r['MIS'] + $r['MIB'] + $r['MIR']+ $r['MIR2'] + $r['MIR3'];
	echo "<DIV STYLE='POSITION:absolute; LEFT:".$total_izq."px; TOP:".$total_top."px;'>".$total."</DIV>";
}
?>
