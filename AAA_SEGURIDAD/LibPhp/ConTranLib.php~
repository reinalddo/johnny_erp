...
*   @param  string  $Dbase  Nombre de base de datos a grabar
**/
function fAgregaComprobante(&$db, $TipoComp, $NumComp, $RegNumero, $FecTrans, $FecContab, $FecVencim, $Emisor,
                    ...
                    $EstProceso, $EstOperacion, $NumProceso, $CodMoneda, $Usuario, $NumPeriodo, $FecDigita, $Dbase="")
{
    ...
    if (!($Libro >0)) $Libro = 9999;
       $slSql = "INSERT INTO " . $Dbase . ".concomprobantes (
...
*   @param  array   $alRec        Arreglo que contiene los valores a insertar, con indide = nombre del campo
*   @param  array   $Dbase        Base de datos a grabar
* 	@return bool                  Resultado de la inserción
* 	
*/
function fInsDetalleCont(&$conn, &$alRec, $Dbase="")
 {
    ...
    $sql = "INSERT INTO " . $Dbase . ".condetalle (
                det_regnumero,
                det_tipocomp,
                det_numcomp,
                det_secuencia,
