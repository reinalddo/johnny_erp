...
{report_header}
   ...
   <table border=1 cellspacing=0 >
    ...
    <tr style="font-weight:bold; text-align: center; vertical-align:middle; font-size:6pt;">
      <td class="headerrow" colspan=16 style="background-color: #BDBDBD;">{$subtitulo} {$rec.EGNombre}</td>   
    </tr>
    <tr style="font-weight:bold; text-align: center; vertical-align:middle; font-size:6pt;">
      <td class="headerrow" colspan=16 style="background-color: #BDBDBD;">{$subtitulo2}</td>   
    </tr>
    ...
    <tr style="font-weight:bold; text-align: center; vertical-align:middle; font-size:6pt;">
      ...
      <td class="headerrow" colspan=7 style="background-color: #F78181;">DESCUENTOS</td>
	...
	<td class="headerrow" style="background-color: #F5A9A9;">Rte. Fte.</td>
