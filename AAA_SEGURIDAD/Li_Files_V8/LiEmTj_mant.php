<?php
/*
 *  @rev    fah     31/01/08    Eliminar error de redireccionamiento al grabar modificaciones (ServerUrl)
 *                              Presentar el usuario que modifico el registro correctamente, no el que consulta un registro
 **/
...
//Operation Method @396-D32F172A
    function Operation()
    {
        ...
        $Redirect = "../Li_Files/" . $FileName . "?" . CCGetQueryString("QueryString", Array("ccsForm")); // #fah31/01/08
...
//InsertRow Method @396-1A880322
    function InsertRow()
    {
        ...
        $this->ds->tac_Usuario->SetValue(fUsuario());
...
//Open Method @396-844708F7
    function Open()
    {
        ...
        "emb_SemTermino, emb_Estado, emb_CodPuerto, par_Descripcion, buq_Abreviatura, conpersonas.*, " .
				"concat(buq_Abreviatura,' - ',emb_NumViaje, '   (Sem ', emb_SemInicio,' a ', emb_SemTermino, ', entre  ', date_format(emb_fecInicio,'%d/%b/%y'), ' y ', date_format(emb_fectermino,'%d/%b/%y'), ')') AS txtEmbarque, " .
				"concat(per_Apellidos,' ',per_Nombres) AS txtEmbarcador, tac_Contenedor, tac_Sello " .
...
//Insert Method @396-9D721663
    function Insert()
    {
        ...
        $this->cp["tac_Contenedor"] = new clsSQLParameter("ctrltac_Contenedor", ccsText, "", "", $this->tac_Contenedor->GetValue(), '', false, $this->ErrorBlock);
        $this->cp["tac_Sello"] = new clsSQLParameter("ctrltac_Sello", ccsText, "", "", $this->tac_Sello->GetValue(), '', false, $this->ErrorBlock);				
        ...
        $this->SQL = "INSERT INTO liqtarjacabec ("
            ...
            . $this->ToSQL(CCGetParam("tac_Contenedor", "--"), $this->cp["tac_Contenedor"]->DataType) . ", "
            . $this->ToSQL(CCGetParam("tac_Sello", ""), $this->cp["tac_Sello"]->DataType)
             . ")";
    ...
    function Update()
    {
        ...
        $this->SQL = "UPDATE liqtarjacabec SET "
             ...
             . "tac_FecDigitacion=" . $this->ToSQL($this->cp["tac_FecDigitacion"]->GetDBValue(), $this->cp["tac_FecDigitacion"]->DataType) . ", "
						 . "tac_Contenedor=" . $this->ToSQL(CCGetParam("tac_Contenedor", ""), $this->cp["tac_Contenedor"]->DataType) . ", "
						 . "tac_Sello=" . 		 $this->ToSQL(CCGetParam("tac_Sello", ""), $this->cp["tac_Sello"]->DataType);
