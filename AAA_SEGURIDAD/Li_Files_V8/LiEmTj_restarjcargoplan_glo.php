...
;
   ...
   $sql = PivotTableSQL(
        $db,                                      # adodb connection
        'liqtarjacabec
	        join genconsolidacion on cns_TipoREg="T" and cns_ID = tar_numtarja
		join liqtarjadetal on tad_numtarja = tar_numtarja
		...
		"concat(act_descripcion, ' ', act_descripcion1) as txt_producto, tac_codempresa, 
   ...
   return $db->Execute($sql . " ORDER BY txt_producto , tac_codempresa, txt_vapor");
}
