<?php
/*
*   LiliTj_liprepro.php: Listado de Tarjas valorizado pro productor
...
*   @return void
*/
function before_group_NOM (&$rpt, &$group) {
    global $db;
    global $glProTxt;
/*
    $slProduc = "";
...
$rep->addGrp('NOM');
    $rep->groups['NOM']->fontSize=6;
    $rep->groups['NOM']->textCol='NOM';
    $rep->addResumeLine('NOM','S', '',0);
        $rep->setAggregate('NOM',0, 'SEM','-');
        $rep->setAggregate('NOM',0, 'NOM','-');
        $rep->setAggregate('NOM',0, 'VAP','-');
        $rep->setAggregate('NOM',0, 'MAR','-');
        $rep->setAggregate('NOM',0, 'EMP','-');
        $rep->setAggregate('NOM',0, 'NOM','-');
        $rep->setAggregate('NOM',0, 'TAR','-');
        $rep->setAggregate('NOM',0, 'PRE','-');
        $rep->setAggregate('NOM',0, 'BON','-');
        $rep->setAggregate('NOM',0, 'DIF','-');
