<?php
/*
*   LiliRp_resumen2.php: Emite un resumen general de liquidaciones, en formato pdf VERSION DISTRIBUIDA
...
$rep->groups['C0']->linesAfter=0;
$rep->groups['C0']->linesBefore=0;
$rep->addResumeLine('C0','S', 'SUMA PRODUCTOR');      // Add a resume line for group C0 using sums in all columns bt default
$rep->setAggregate('C0',0, 'C0','-'); // Change aggregate to '-' (nothing)  for column 'CO' in resumline 1 of Group 'CO'
$rep->setAggregate('C0',0, 'EM','-'); // Change aggregate to '-' (nothing)  for column 'CO' in resumline 1 of Group 'CO'
$rep->setAggregate('C0',0, 'C1','-'); // Change aggregate to '-' (nothing)  for column 'C1' in resumline 1 of Group 'CO'
$rep->setAggregate('C0',0, 'C2','-'); // Change aggregate to '-' (nothing)  for column 'C2' in resumline 1 of Group 'CO'
