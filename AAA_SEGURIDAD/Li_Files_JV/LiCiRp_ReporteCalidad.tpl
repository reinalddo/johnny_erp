...
<!-- 
	...
	<tr>
	  <td style="width:14cm; vertical-align:middle; text-align:center;font-size:1.4em; font-family:cursive;"><br><br><i>This is to certify,
	      ...
	      received from Messrs. <b>{$rec.Shipper}</b>.</i></td>
	  <td style="vertical-align:middle;"> </td>
	</tr>
      </table>
      <br><br>
	...
	<tr>
	  ...
	  <!-- <td style="width:4cm; vertical-align:middle;">{$rec.Cliente}</td> -->
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td style="width:12cm; vertical-align:middle;">{$sum.CajasTotales}</td>
	</tr>
	<tr>
...
{report_detail}
	...
	<tr>
	  ...
	  <td style="vertical-align:middle;text-align:left;">{$rec.Empaque}</td>
	  ...
	  <td style="vertical-align:middle;text-align:right;">{$rec.Peso|number_format:2}</td>
	</tr>
...
{report_footer}
	...
	<tr>
	  ...
	  <td style="vertical-align:middle; text-align:right;font-weight:bold;background-color:#BDBDBD;">{$avg.Peso|number_format:2}</td>
	</tr>
      </table>
      <br><br>
      <table style="font-size:1.4em;">
