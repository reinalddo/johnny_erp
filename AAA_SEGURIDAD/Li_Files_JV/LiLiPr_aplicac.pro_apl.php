...
//                                     "</td><td>";
		...
		$flPrecUnit = fTraePrecioItem($db, $result->fields['dos_CodItem'], 4); //#fah14/06/2010 : Lista de precios a pagar (antes estaba 3)
...
//echo "<br><br><br>";
		...
		$alDetalle['det_RegNumero']     = $ilRegNumero;
                ...
                $alDetalle['det_CanDespachada'] = round($rsLiquida->fields['tmp_CantEmbar'] *  ($flMultip ? $dlMultip : 1),2); // El tercer parametro es un multiplicador de cantidad
...
//echo "<br>2 ";
                if ($flCanti == 0) $flPrecUnit =0;
                  ...
                  $flPrecUnit = fTraePrecioItem($db, $rsLiquida->fields['det_CodItem'], 3);
                }
//echo "<br>3 ";
...
//echo "<br>5 ";
			...
			$flPrecUnit = fTraePrecioItem($db, $rsLiquida->fields['det_CodItem'], 4); //#fah14/06/2010 : Lista de precios a pagar
...
//if ($ilCodItem == "25041") echo "<br> Termina: " . $flCanti . " // " . $flSalCant;
    ...
    //          Agregar un comprobante LN por lo que no se pague al productor (saldo negativo no justficado por historia)
		...
		$flPrecUnit = fTraePrecioItem($db, $rsLiquida->fields['det_CodItem'], 4);  //#fah10/06/09 Hacer que el precio a pagar sea el de lista, no el promedio //#fah14/06/2010 : Lista de precios a pagar
...
function fTraePrecioItem($db, $pItem, $pList=3 ){
    $flPrecUnit = NZ(fDBValor($db, 'invprecios', 'pre_preUnitario', 'pre_CodItem = ' . $pItem . ' AND pre_LisPrecios = 3'));
    if ($flPrecUnit == 0)  {
