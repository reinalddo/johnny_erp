<?php /* Smarty version 2.6.18, created on 2015-09-15 14:23:40
         compiled from InTrTr_mercaexcel.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'InTrTr_mercaexcel.tpl', 23, false),array('block', 'report_header', 'InTrTr_mercaexcel.tpl', 26, false),array('block', 'report_detail', 'InTrTr_mercaexcel.tpl', 60, false),array('modifier', 'date_format', 'InTrTr_mercaexcel.tpl', 29, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr>
        <td><?php echo $this->_tpl_vars['rec']['MSM']; ?>
</td>
        <td><?php echo $this->_tpl_vars['rec']['MCO']; ?>
</td>
        <td><?php echo $this->_tpl_vars['rec']['MCI']; ?>
</td>
        <td><?php echo $this->_tpl_vars['rec']['MCE']; ?>
</td>
        <td><?php echo $this->_tpl_vars['rec']['MRT']; ?>
</td>        
        <td><?php echo $this->_tpl_vars['rec']['MWO']; ?>
</td>        
    </tr>
