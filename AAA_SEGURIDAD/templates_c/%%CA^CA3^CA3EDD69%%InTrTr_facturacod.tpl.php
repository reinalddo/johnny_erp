<?php /* Smarty version 2.6.18, created on 2015-04-13 17:51:13
         compiled from InTrTr_facturacod.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'InTrTr_facturacod.tpl', 46, false),array('block', 'report_header', 'InTrTr_facturacod.tpl', 47, false),array('block', 'report_detail', 'InTrTr_facturacod.tpl', 99, false),array('block', 'report_footer', 'InTrTr_facturacod.tpl', 109, false),array('modifier', 'truncate', 'InTrTr_facturacod.tpl', 67, false),array('modifier', 'number_format', 'InTrTr_facturacod.tpl', 101, false),array('modifier', 'regex_replace', 'InTrTr_facturacod.tpl', 129, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<!--  Plantilla para reporte de Tarjas por Vapor, marca:
	  Tabla de doble entrada, en vertical los productores, agrupados por zona; en la horizontal las marcas agrupadas por producto -->
...
<?php $this->_tag_stack[] = array('report_header', array()); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    ...
    <?php $this->assign('numCol', 7); ?>
        ...
        <div id = "cuerpo" style="height:9.5cm; border:#FFFFFF solid 1px; margin-top:140pt;">
 ...
 style="height:50px;font-size:16px;font-weight:bold;text-align:center;vertical-align:middle;">
	    ...
	    <td colspan=1 class="resalta" nowrap style="width:100pt"><strong>CLIENTE:</strong></td>
            <td colspan=1 class="" nowrap  style="width:300pt"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['RECEP'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 40) : smarty_modifier_truncate($_tmp, 40)); ?>
</td>
	  ...
	  <td colspan=1 class="resalta" nowrap><strong>DIRECCION:</strong></td>
        ...
        <tr>
            ...
            <td colspan=2 class="resalta " nowrap style="width:60pt"><strong>TELEFONO:</strong></td>
      	   <td colspan=1 class="" style="width:95pt"><?php echo $this->_tpl_vars['rec']['telefono']; ?>
</td>
        </tr>
        <tr>
...
<?php $this->_tag_stack[] = array('report_footer', array()); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<td nowrap class="coldata espacioIzq">REF.OP.: <?php echo $this->_tpl_vars['rec']['REFOP']; ?>
</td>
  ...
  <tr>
    ...
    <tr style="padding-top:20px;">
        <td colspan=2 rowspan=9 class="espacioCol1 resalta" style="vertical-align: top; width:300pt"<strong>SON: </strong><?php echo $this->_tpl_vars['letras']; ?>
</td>
    ...
    <tr>
        ...
        <td class="colnum der" style="padding-top:0px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['iva'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
    </tr>
    <tr>
