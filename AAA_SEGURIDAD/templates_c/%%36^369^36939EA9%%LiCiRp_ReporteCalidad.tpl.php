<?php /* Smarty version 2.6.18, created on 2011-11-29 18:02:53
         compiled from ../Li_Files/LiCiRp_ReporteCalidad.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', '../Li_Files/LiCiRp_ReporteCalidad.tpl', 13, false),array('block', 'report_header', '../Li_Files/LiCiRp_ReporteCalidad.tpl', 14, false),array('block', 'report_detail', '../Li_Files/LiCiRp_ReporteCalidad.tpl', 192, false),array('block', 'report_footer', '../Li_Files/LiCiRp_ReporteCalidad.tpl', 210, false),array('modifier', 'number_format', '../Li_Files/LiCiRp_ReporteCalidad.tpl', 104, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<!--  Plantilla para Reporte de Calidad -->
...
<br>Phone <?php echo $this->_tpl_vars['rec']['ETel']; ?>
	...
	<tr>
	  <td style="width:3cm; vertical-align:middle;" rowspan="3"><img src="../Images/InformeCliente/logo382x327.jpg" width="3cm" height="3cm"></td>
	  <td style="width:14cm; vertical-align:middle; text-align:center;font-size:2.2em;"><br>QUALITY DEPARTMENT</td>
	  <td style="vertical-align:middle;"></td>
	</tr>
	<tr>
	  <td style="width:14cm; vertical-align:middle; text-align:center;font-size:1.6em;"><br>LOADING SURVEY REPORT</td>
	  <td style="vertical-align:middle;"> </td>
	</tr>
	<tr>
	  <td style="width:14cm; vertical-align:middle; text-align:center;font-size:1.4em; font-family:cursive;"><br><br><i>This is to certify,
	      that we attended and performed
	      the inspection of quality. quantity and weight of the above mentioned consignment in accordance with instructions
	      received from Messrs. <b><?php echo $this->_tpl_vars['rec']['Shipper']; ?>
</b>.</i></td>
	  <td style="vertical-align:middle;"> </td>
	</tr>
      </table>
	...
	<tr>
	  ...
	  <td style=" vertical-align:middle;">TO THE ORDER</td>
	  <!-- <td style="width:4cm; vertical-align:middle;"><?php echo $this->_tpl_vars['rec']['Cliente']; ?>
</td> -->
	</tr>
	<tr>
...
-Viaje:<?php echo $this->_tpl_vars['rec']['Viaje']; ?>
	...
	<tr>
	  ...
	  <td style="width:12cm; vertical-align:middle;"><?php echo $this->_tpl_vars['sum']['CajasTotales']; ?>
</td>
	</tr>
	<tr>
 ...
 Kg. Gross</td>
	...
	<tr style="font-weight:bold;">
	  ...
	  <td style="width:2cm; vertical-align:middle;text-align:center;background-color:#BDBDBD;">Farm Name</td>
	  <td style="width:2cm; vertical-align:middle;text-align:center;background-color:#BDBDBD;">Mark</td>
	  <td style="width:2cm; vertical-align:middle;text-align:center;background-color:#BDBDBD;">Type of Cartons</td>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<tr>
	  ...
	  <td style="vertical-align:middle;text-align:left;"><?php echo $this->_tpl_vars['rec']['Empaque']; ?>
</td>
	  ...
	  <td style="vertical-align:middle;text-align:right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['Peso'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
	</tr>
...
<?php $this->_tag_stack[] = array('report_footer', array()); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<tr>
	  ...
	  <td style="vertical-align:middle; text-align:right;font-weight:bold;background-color:#BDBDBD;"><?php echo ((is_array($_tmp=$this->_tpl_vars['avg']['Peso'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
	</tr>
      </table>
      <br><br>
      <table style="font-size:1.4em;">
	<tr>
	  <td style="vertical-align:middle; font-weight:bold;" colspan=2>IV. SPECIFICATIONS:</td>
	</tr>
	<!-- <tr>
...
%, <?php echo $this->_tpl_vars['sum']['Embarcadas']; ?>
 boxes (Minimum quality: 80,00%)
	...
	<tr>
	  <td style="width:4cm; vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x&nbsp;Minimun Grade:</td>
	  <td style="vertical-align:middle;">39 degree</td>
	</tr>
	<tr>
	  <td style="width:4cm; vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x&nbsp;Maximum Grade:</td>
	  <td style="vertical-align:middle;">46 degree</td>
	</tr>
	<tr>
	  <td style="width:4cm; vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x&nbsp;Length of finger:</td>
	  <td style="vertical-align:middle;">8.0 inches minimum</td>
	</tr>
      </table><br><br>
      <table style="font-size:1.4em;">
	<tr>
