<?php /* Smarty version 2.6.18, created on 2015-04-13 18:47:15
         compiled from InTrTr_facturaSchaffry.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'InTrTr_facturaSchaffry.tpl', 43, false),array('block', 'report_header', 'InTrTr_facturaSchaffry.tpl', 44, false),array('block', 'report_detail', 'InTrTr_facturaSchaffry.tpl', 86, false),array('block', 'report_footer', 'InTrTr_facturaSchaffry.tpl', 97, false),array('modifier', 'truncate', 'InTrTr_facturaSchaffry.tpl', 52, false),array('modifier', 'number_format', 'InTrTr_facturaSchaffry.tpl', 89, false),array('modifier', 'regex_replace', 'InTrTr_facturaSchaffry.tpl', 100, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<!--  Plantilla de Impresion de Factura para Alex Schaffry
...
<?php $this->_tag_stack[] = array('report_header', array()); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    ...
    <?php $this->assign('numCol', 7); ?>
 			 <!--  18.5cm -->   			
    <div id = "cuerpo" style="height:15.5cm; border:#FFFFFF solid 1px; margin-top:111pt;">
    <table border=0 cellpadding=2pt; style="padding-left: 50pt; border:#FFFFFF solid 1px;" >
        <tr>
	       ...
	       <td style="width:130pt;"><!--<strong>GUIA REMISION:</strong>--></td>
