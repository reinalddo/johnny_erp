<?php /* Smarty version 2.6.18, created on 2010-05-06 09:55:13
         compiled from LiEmTr_dettarjdiario_Gestion.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'LiEmTr_dettarjdiario_Gestion.tpl', 11, false),array('block', 'report_header', 'LiEmTr_dettarjdiario_Gestion.tpl', 13, false),array('block', 'report_detail', 'LiEmTr_dettarjdiario_Gestion.tpl', 41, false),array('modifier', 'number_format', 'LiEmTr_dettarjdiario_Gestion.tpl', 51, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<tr style="white-space:nowrap">
			<td><?php echo $this->_tpl_vars['rec']['zona_origen']; ?>
</td>
			<td><?php echo $this->_tpl_vars['rec']['ZONA_PAGO']; ?>
</td>
			<td><?php echo $this->_tpl_vars['rec']['ZONA_CORTE']; ?>
</td>
			...
			<td class="colnum"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['txp_PrecFac'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 4) : smarty_modifier_number_format($_tmp, 4)); ?>
</td>
			<td class="colnum"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['txp_PrecFac']*$this->_tpl_vars['rec']['txp_CantPagar'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
         </tr>
