<?php /* Smarty version 2.6.18, created on 2010-06-03 10:51:05
         compiled from LiEmTr_dettarjdiario_total_prec_empresa.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'LiEmTr_dettarjdiario_total_prec_empresa.tpl', 11, false),array('block', 'report_header', 'LiEmTr_dettarjdiario_total_prec_empresa.tpl', 13, false),array('block', 'report_detail', 'LiEmTr_dettarjdiario_total_prec_empresa.tpl', 56, false),array('block', 'report_footer', 'LiEmTr_dettarjdiario_total_prec_empresa.tpl', 68, false),array('modifier', 'date_format', 'LiEmTr_dettarjdiario_total_prec_empresa.tpl', 23, false),array('modifier', 'number_format', 'LiEmTr_dettarjdiario_total_prec_empresa.tpl', 60, false),)), $this); ?>
...
<div id="container"  style="height: 98% !important">
 ...
 style="text-align: center; font-weight:bold; ">APROBACION DE PRECIOS DETALLADO</td>
			  
			</tr>
			<tr>
			  <td class="colhead" colspan=<?php echo $this->_tpl_vars['gsNumCols']; ?>
 style="text-align: left; font-weight:bold; ">Fecha Imp.: <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
</td>
			   
			</tr>
			<tr>
			  <td class="colhead" colspan=<?php echo $this->_tpl_vars['gsNumCols']; ?>
 style="text-align: left;font-weight:bold; "><?php echo $this->_tpl_vars['gsSubTitul']; ?>
</td>
			</tr>
...
<?php $this->_tag_stack[] = array('report_footer', array('group' => 'txp_Shipper')); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
  ...
  <tr>
    <td colspan=2 align=center>Elaborado por <?php echo $_SESSION['g_user']; ?>
</td>
