<?php /* Smarty version 2.6.18, created on 2015-07-23 11:43:42
         compiled from InTrTr_listasimple.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'InTrTr_listasimple.tpl', 26, false),array('block', 'report_header', 'InTrTr_listasimple.tpl', 29, false),array('block', 'report_detail', 'InTrTr_listasimple.tpl', 68, false),array('block', 'report_footer', 'InTrTr_listasimple.tpl', 86, false),array('modifier', 'date_format', 'InTrTr_listasimple.tpl', 33, false),array('modifier', 'number_format', 'InTrTr_listasimple.tpl', 79, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report', array('recordset' => $this->_tpl_vars['agData'],'record' => 'rec','groups' => "BODEG, TIPO, COMPR, RECEP,  SECUE",'resort' => true)); $_block_repeat=true;smarty_block_report($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
<?php $this->_tag_stack[] = array('report_header', array('group' => 'BODEG')); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
 ...
 style="padding-top:20px; text-align:center; font-size:14px;"><strong><?php echo $this->_tpl_vars['rec']['BODEG']; ?>
    ...
    <tr style="font-weight:bold; text-align:center; vertical-align:middle;">
	    ...
	    <td class="headerrow">SEMANA</td>
	    <td class="headerrow">DESTINO/ORIGEN</td>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr>
	    ...
	    <td class="headerrow"><?php echo $this->_tpl_vars['rec']['TIPO']; ?>
<?php echo $this->_tpl_vars['rec']['COMPR']; ?>
</td>
	    <td class="headerrow"><?php echo $this->_tpl_vars['rec']['FECHA']; ?>
</td>
    <td class="headerrow"><?php echo $this->_tpl_vars['rec']['REFOP']; ?>
</td>
	    <td class="headerrow"><?php echo $this->_tpl_vars['rec']['CODRE']; ?>
