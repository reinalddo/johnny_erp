<?php /* Smarty version 2.6.18, created on 2011-01-14 15:53:14
         compiled from InTrTr_saldobod.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'InTrTr_saldobod.tpl', 27, false),array('block', 'report_header', 'InTrTr_saldobod.tpl', 29, false),array('block', 'report_detail', 'InTrTr_saldobod.tpl', 64, false),array('block', 'report_footer', 'InTrTr_saldobod.tpl', 78, false),array('modifier', 'number_format', 'InTrTr_saldobod.tpl', 69, false),)), $this); ?>
...
<title>Toma Fisica de Inventario <?php echo $this->_tpl_vars['gsSubTitul']; ?>
</title>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<tr style="white-space:nowrap">
			...
			<td><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['SAN'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
			<td><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['CIN'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
			<td><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['CEG'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>		
			<td class="colnum"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['SAC'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
...
<?php $this->_tag_stack[] = array('report_footer', array('group' => 'grupo')); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		  <tr> 
			<td colspan="3" style="text-align:right"><?php echo $this->_tpl_vars['rec']['grupo']; ?>
...
<?php $this->_tag_stack[] = array('report_footer', array()); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		  <tr> 
			<td colspan="9" style="text-align:right">TOTAL : <?php echo ((is_array($_tmp=$this->_tpl_vars['sum']['PUN'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 5) : smarty_modifier_number_format($_tmp, 5)); ?>
</td>
