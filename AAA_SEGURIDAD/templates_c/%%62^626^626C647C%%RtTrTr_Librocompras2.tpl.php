<?php /* Smarty version 2.6.18, created on 2015-12-12 15:49:22
         compiled from RtTrTr_Librocompras2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'RtTrTr_Librocompras2.tpl', 15, false),array('block', 'report_header', 'RtTrTr_Librocompras2.tpl', 16, false),array('block', 'report_detail', 'RtTrTr_Librocompras2.tpl', 182, false),array('block', 'report_footer', 'RtTrTr_Librocompras2.tpl', 353, false),array('modifier', 'date_format', 'RtTrTr_Librocompras2.tpl', 18, false),array('modifier', 'number_format', 'RtTrTr_Librocompras2.tpl', 109, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_header', array('group' => 'ID')); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<?php $this->assign('ret0', 0); ?>
	<?php $this->assign('ret1', 0); ?>
	<?php $this->assign('ret11', 0); ?>
	<?php $this->assign('ret12', 0); ?>
	<?php $this->assign('ret2', 0); ?>
	<?php $this->assign('ret5', 0); ?>
	<?php $this->assign('ret8', 0); ?>
	<?php $this->assign('ret25', 0); ?>
	<?php if (( $this->_tpl_vars['rec']['RET_1'] != 0 || $this->_tpl_vars['rec']['RET_11'] != 0 || $this->_tpl_vars['rec']['RET_12'] != 0 || $this->_tpl_vars['rec']['RET_2'] != 0 ) || $this->_tpl_vars['rec']['RET_5'] != 0 || $this->_tpl_vars['rec']['RET_8'] != 0 || $this->_tpl_vars['rec']['RET_25'] != 0): ?>
	  <?php if (( $this->_tpl_vars['rec']['RET_1'] != 0 )): ?>
	    <?php $this->assign('ret1', 1); ?>
	  ...
	  <?php elseif (( $this->_tpl_vars['rec']['RET_11'] != 0 )): ?>
	    <?php $this->assign('ret11', 1); ?>
	    <td class="colnum " style="text-align:right;">1%</td>
	    <td class="colnum " style="text-align:right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['RET_11'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
            <td class="colnum " style="text-align:right;"><?php echo $this->_tpl_vars['rec']['CRT_11']; ?>
</td>
	  <?php elseif (( $this->_tpl_vars['rec']['RET_12'] != 0 )): ?>
	    <?php $this->assign('ret12', 1); ?>
	    <td class="colnum " style="text-align:right;">1%</td>
	    <td class="colnum " style="text-align:right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['RET_12'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
            <td class="colnum " style="text-align:right;"><?php echo $this->_tpl_vars['rec']['CRT_12']; ?>
</td>
	  <?php elseif (( $this->_tpl_vars['rec']['RET_2'] != 0 )): ?>
	    <?php $this->assign('ret2', 1); ?>
	  ...
	  <?php elseif (( $this->_tpl_vars['rec']['RET_5'] != 0 )): ?>
	    <?php $this->assign('ret5', 1); ?>
	  ...
	  <?php elseif (( $this->_tpl_vars['rec']['RET_8'] != 0 )): ?>
	    <?php $this->assign('ret8', 1); ?>
	  ...
	  <?php elseif (( $this->_tpl_vars['rec']['RET_25'] != 0 )): ?>
	    <?php $this->assign('ret25', 1); ?>
	...
	<?php else: ?>
	    ...
	    <td class="colnum " style="text-align:right;"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['RET_0'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
       <td class="colnum " style="text-align:right;"><?php echo $this->_tpl_vars['rec']['CRT_0']; ?>
</td>
	<?php endif; ?>
	
		
	<?php $this->assign('ret', $this->_tpl_vars['rec']['valorRetBienes']+$this->_tpl_vars['rec']['valorRetServicios']+$this->_tpl_vars['rec']['RET_1']+$this->_tpl_vars['rec']['RET_11']+$this->_tpl_vars['rec']['RET_12']+$this->_tpl_vars['rec']['RET_2']+$this->_tpl_vars['rec']['RET_5']+$this->_tpl_vars['rec']['RET_8']+$this->_tpl_vars['rec']['RET_25']); ?>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
        ...
        <?php if (( $this->_tpl_vars['rec']['RET_1'] != 0 && $this->_tpl_vars['ret1'] != 1 )): ?>
        ...
        <?php endif; ?>
        <?php if (( $this->_tpl_vars['rec']['RET_11'] != 0 && $this->_tpl_vars['ret11'] != 1 )): ?>
            <tr><td class="colnum "><?php echo $this->_tpl_vars['rec']['ID']; ?>
</td>
		<td nowrap><?php echo $this->_tpl_vars['rec']['Proveedor']; ?>
</td>
        ...
        <?php endif; ?>
        <?php if (( $this->_tpl_vars['rec']['RET_12'] != 0 && $this->_tpl_vars['ret12'] != 1 )): ?>
            <tr><td class="colnum "><?php echo $this->_tpl_vars['rec']['ID']; ?>
</td>
		<td nowrap><?php echo $this->_tpl_vars['rec']['Proveedor']; ?>
</td>
        ...
        <?php endif; ?>
        <?php if (( $this->_tpl_vars['rec']['RET_2'] != 0 && $this->_tpl_vars['ret2'] != 1 )): ?>
            <tr><td class="colnum "><?php echo $this->_tpl_vars['rec']['ID']; ?>
</td>
		<td nowrap><?php echo $this->_tpl_vars['rec']['Proveedor']; ?>
</td>
        ...
        <?php if (( $this->_tpl_vars['rec']['RET_5'] != 0 && $this->_tpl_vars['ret5'] != 1 )): ?>
            <tr><td class="colnum "><?php echo $this->_tpl_vars['rec']['ID']; ?>
</td>
		<td nowrap><?php echo $this->_tpl_vars['rec']['Proveedor']; ?>
</td>
        ...
        <?php if (( $this->_tpl_vars['rec']['RET_8'] != 0 && $this->_tpl_vars['ret8'] != 1 )): ?>
            <tr><td class="colnum "><?php echo $this->_tpl_vars['rec']['ID']; ?>
</td>
		<td nowrap><?php echo $this->_tpl_vars['rec']['Proveedor']; ?>
</td>
        ...
        <?php if (( $this->_tpl_vars['rec']['RET_25'] != 0 && $this->_tpl_vars['ret25'] != 1 )): ?>
            <tr><td class="colnum "><?php echo $this->_tpl_vars['rec']['ID']; ?>
</td>
		<td nowrap><?php echo $this->_tpl_vars['rec']['Proveedor']; ?>
</td>
...
<?php $this->_tag_stack[] = array('report_footer', array()); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<td class="colnum headerrow"><?php echo ((is_array($_tmp=$this->_tpl_vars['sum']['valorRetServicios'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
        ...
        <td>&nbsp</td>
	<td class="colnum headerrow"><?php echo ((is_array($_tmp=$this->_tpl_vars['sum']['RET_1']+$this->_tpl_vars['sum']['RET_11']+$this->_tpl_vars['sum']['RET_12']+$this->_tpl_vars['sum']['RET_2']+$this->_tpl_vars['sum']['RET_5']+$this->_tpl_vars['sum']['RET_8']+$this->_tpl_vars['sum']['RET_25'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
	
        <td class="colnum " style="text-align:right;"></td>
	<?php $this->assign('retGen', $this->_tpl_vars['sum']['valorRetBienes']+$this->_tpl_vars['sum']['valorRetServicios']+$this->_tpl_vars['sum']['RET_1']+$this->_tpl_vars['sum']['RET_11']+$this->_tpl_vars['sum']['RET_12']+$this->_tpl_vars['sum']['RET_2']+$this->_tpl_vars['sum']['RET_5']+$this->_tpl_vars['sum']['RET_8']+$this->_tpl_vars['sum']['RET_25']); ?>
