<?php /* Smarty version 2.6.18, created on 2015-03-31 16:00:17
         compiled from InTrTr_facturablancoA4.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'InTrTr_facturablancoA4.tpl', 45, false),array('block', 'report_header', 'InTrTr_facturablancoA4.tpl', 46, false),array('block', 'report_detail', 'InTrTr_facturablancoA4.tpl', 120, false),array('block', 'report_footer', 'InTrTr_facturablancoA4.tpl', 130, false),array('modifier', 'truncate', 'InTrTr_facturablancoA4.tpl', 87, false),array('modifier', 'number_format', 'InTrTr_facturablancoA4.tpl', 122, false),array('modifier', 'regex_replace', 'InTrTr_facturablancoA4.tpl', 150, false),array('modifier', 'date_format', 'InTrTr_facturablancoA4.tpl', 202, false),)), $this); ?>
...
<!--        <tr>
 ...
 style="height:50px;font-size:16px;font-weight:bold;text-align:center;vertical-align:middle;">
	    ...
	    <td colspan=1 class="resalta" nowrap style="width:100pt"><strong>CLIENTE:</strong></td>
            <td colspan=1 class="" nowrap  style="width:400pt"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['RECEP'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 80) : smarty_modifier_truncate($_tmp, 80)); ?>
</td>
	  ...
	  <td colspan=1 class="resalta" nowrap><strong>DIRECCION:</strong></td>
            <td colspan=1 class="" nowrap><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['direccion'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 80) : smarty_modifier_truncate($_tmp, 80)); ?>
</td>
            <td colspan=1>&nbsp;</td>
        </tr>
        <tr>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr><!-- style="border:#000000 solid 1px;">-->
        <td class="colnum der" style="padding: 0px 55px 0px 0px"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['CANTI'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0) : smarty_modifier_number_format($_tmp, 0)); ?>
	     ...
	     <td nowrap class="coldata espacioIzq"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['ITEM'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 80) : smarty_modifier_truncate($_tmp, 80)); ?>
</td>
...
<?php $this->_tag_stack[] = array('report_footer', array()); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<td nowrap class="coldata espacioIzq">REF.: <?php echo $this->_tpl_vars['rec']['REFOP']; ?>
</td>
