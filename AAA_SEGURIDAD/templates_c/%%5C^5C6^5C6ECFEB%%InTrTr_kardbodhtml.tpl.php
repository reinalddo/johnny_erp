<?php /* Smarty version 2.6.18, created on 2009-12-08 11:59:59
         compiled from InTrTr_kardbodhtml.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'InTrTr_kardbodhtml.tpl', 12, false),array('block', 'report_header', 'InTrTr_kardbodhtml.tpl', 13, false),array('block', 'report_detail', 'InTrTr_kardbodhtml.tpl', 74, false),array('block', 'report_footer', 'InTrTr_kardbodhtml.tpl', 100, false),array('modifier', 'date_format', 'InTrTr_kardbodhtml.tpl', 69, false),array('modifier', 'number_format', 'InTrTr_kardbodhtml.tpl', 85, false),array('function', 'addto', 'InTrTr_kardbodhtml.tpl', 91, false),)), $this); ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
    ...
    <?php $this->_tag_stack[] = array('report', array('recordset' => $this->_tpl_vars['agData'],'record' => 'rec','resort' => false,'groups' => 'DES')); $_block_repeat=true;smarty_block_report($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
<tbody>
	...
	<td align="center" ><fsize="2" face="Verdana, Arial, Helvetica,   sans-serif">C. UNI</td>
	  ...
	  <tfoot>
	  <tr> 
			<td colspan="15" style="text-align:left"><?php echo $_SESSION['g_user']; ?>
  ...
  <?php if ($this->_tpl_vars['fgBandera'] != $this->_tpl_vars['rec']['DES']): ?><?php $this->_tpl_vars['fgSumCant'] = 0; ?><?php endif; ?>
    <?php if ($this->_tpl_vars['fgBandera'] != $this->_tpl_vars['rec']['DES']): ?><?php $this->_tpl_vars['fgSumCant1'] = 0; ?><?php endif; ?> 
      <tr >	
	    ...
	    <td align="left" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo $this->_tpl_vars['rec']['COM']; ?>
</td>
	    <td align="left" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo $this->_tpl_vars['rec']['FEC']; ?>
</td>
	    <td align="right" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['CIN'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
	    <td align="right" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo $this->_tpl_vars['rec']['VIN']; ?>
</td>
	     <td align="right" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['VIN'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
	    <td align="right" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['CEG'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
	    <td align="right" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['VEG']/$this->_tpl_vars['rec']['CEG'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 6) : smarty_modifier_number_format($_tmp, 6)); ?>
</td>
	    <td align="right" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['VEG'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
	    <?php echo smarty_function_addto(array('var' => 'fgSumCant','value' => $this->_tpl_vars['rec']['SAC']), $this);?>

	    <td align="right" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo ((is_array($_tmp=$this->_tpl_vars['fgSumCant'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
	    <?php echo smarty_function_addto(array('var' => 'fgSumCant1','value' => $this->_tpl_vars['rec']['VAC']), $this);?>

	    <td align="right" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo ((is_array($_tmp=$this->_tpl_vars['fgSumCant1'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>
	    <td align="right" ><size="2" face="Verdana, Arial, Helvetica,sans-serif"><?php echo ((is_array($_tmp=$this->_tpl_vars['fgSumCant1']/$this->_tpl_vars['fgSumCant'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 6) : smarty_modifier_number_format($_tmp, 6)); ?>
</td>
	    <?php $this->assign('fgBandera', $this->_tpl_vars['rec']['DES']); ?>
	      </tr>
...
<?php $this->_tag_stack[] = array('report_footer', array()); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
        <tr >	
			...
			<td align="center">&nbsp;</td >
			<td align="center">&nbsp;</td >
			<td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['sum']['VIN'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td >
			<td align="center">&nbsp;</td >
			<td align="center">&nbsp;</td >
			<td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['sum']['VEG'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td >
			<td align="center">&nbsp;</td >
			<td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['sum']['VIN']-$this->_tpl_vars['sum']['VEG'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td >
       </tr>
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
         </table>    
