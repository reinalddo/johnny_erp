<?php /* Smarty version 2.6.18, created on 2015-04-13 17:52:35
         compiled from InTrTr_facturaEncoser.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'InTrTr_facturaEncoser.tpl', 46, false),array('block', 'report_header', 'InTrTr_facturaEncoser.tpl', 47, false),array('block', 'report_detail', 'InTrTr_facturaEncoser.tpl', 99, false),array('block', 'report_footer', 'InTrTr_facturaEncoser.tpl', 109, false),array('modifier', 'truncate', 'InTrTr_facturaEncoser.tpl', 67, false),array('modifier', 'number_format', 'InTrTr_facturaEncoser.tpl', 101, false),array('modifier', 'regex_replace', 'InTrTr_facturaEncoser.tpl', 129, false),array('modifier', 'date_format', 'InTrTr_facturaEncoser.tpl', 183, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr><!-- style="border:#000000 solid 1px;">-->
        <td class="colnum der" style="padding: 0px 55px 0px 0px"><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['CANTI'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : smarty_modifier_number_format($_tmp, 2)); ?>
</td>  
