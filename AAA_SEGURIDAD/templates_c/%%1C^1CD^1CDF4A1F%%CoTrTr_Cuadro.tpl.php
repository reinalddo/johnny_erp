<?php /* Smarty version 2.6.18, created on 2014-08-13 19:38:25
         compiled from CoTrTr_Cuadro.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'str_pad', 'CoTrTr_Cuadro.tpl', 2, false),array('modifier', 'date_format', 'CoTrTr_Cuadro.tpl', 33, false),array('modifier', 'number_format', 'CoTrTr_Cuadro.tpl', 75, false),array('block', 'report', 'CoTrTr_Cuadro.tpl', 20, false),array('block', 'report_header', 'CoTrTr_Cuadro.tpl', 22, false),array('block', 'report_detail', 'CoTrTr_Cuadro.tpl', 57, false),array('block', 'report_footer', 'CoTrTr_Cuadro.tpl', 89, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_header', array()); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
 ...
 <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
	...
	<td class="headerrow"><strong>No COMPROBANTE</strong></td>
        <td class="headerrow"><strong>COD.</strong></td>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
  ...
  <tr style="text-align:center; vertical-align:middle;">
	...
	<td class="colnum " >
	    <?php if ($this->_tpl_vars['rec']['numComprobante']): ?>
...
<?php $this->_tag_stack[] = array('report_footer', array()); $_block_repeat=true;smarty_block_report_footer($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr style="font-weight:bold;text-align:center; vertical-align:middle;">
      ...
      <td></td><td></td>
       ...
       <td></td><td><?php echo $this->_tpl_vars['tSaldo']; ?>
</td>
       <td></td>
    </tr>
