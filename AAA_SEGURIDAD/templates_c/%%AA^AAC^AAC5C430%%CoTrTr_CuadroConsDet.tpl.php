<?php /* Smarty version 2.6.18, created on 2010-12-06 15:59:02
         compiled from CoTrTr_CuadroConsDet.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'report', 'CoTrTr_CuadroConsDet.tpl', 22, false),array('block', 'report_header', 'CoTrTr_CuadroConsDet.tpl', 24, false),array('block', 'report_detail', 'CoTrTr_CuadroConsDet.tpl', 61, false),array('block', 'report_footer', 'CoTrTr_CuadroConsDet.tpl', 95, false),array('modifier', 'date_format', 'CoTrTr_CuadroConsDet.tpl', 35, false),array('modifier', 'str_pad', 'CoTrTr_CuadroConsDet.tpl', 73, false),array('modifier', 'number_format', 'CoTrTr_CuadroConsDet.tpl', 80, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('report_header', array()); $_block_repeat=true;smarty_block_report_header($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
 ...
 <br>
   ...
   <table border=1 cellspacing=0 >
    ...
    <tfoot>
      <tr>
	<td colspan="18"> <?php echo $_SESSION['g_user']; ?>
...
<?php $this->_tag_stack[] = array('report_detail', array()); $_block_repeat=true;smarty_block_report_detail($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
  ...
  <tr vertical-align:middle;">
	<td class="colnum "> <?php echo $this->_tpl_vars['rec']['empresa']; ?>
 </td>
	<td class="colnum "> <?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['com_FecContab'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
</td>
...
&pbase=<?php echo $this->_tpl_vars['rec']['base']; ?>
&pempresa=<?php echo $this->_tpl_vars['rec']['empresa']; ?>
" target="_blank">
	    <?php endif; ?>
...
-<?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['secuencial'])) ? $this->_run_mod_handler('str_pad', true, $_tmp, 7, '0', 'STR_PAD_LEFT') : str_pad($_tmp, 7, '0', 'STR_PAD_LEFT')); ?>
	...
	<td class="coldata ">&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['estabretencion1'])) ? $this->_run_mod_handler('str_pad', true, $_tmp, 3, '0', 'STR_PAD_LEFT') : str_pad($_tmp, 3, '0', 'STR_PAD_LEFT')); ?>
...
-<?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['secretencion1'])) ? $this->_run_mod_handler('str_pad', true, $_tmp, 7, '0', 'STR_PAD_LEFT') : str_pad($_tmp, 7, '0', 'STR_PAD_LEFT')); ?>
	...
	<td class="coldata "><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['fechaEmision'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
</td>
        <td class="coldata "><?php echo ((is_array($_tmp=$this->_tpl_vars['rec']['com_FecVencim'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
</td>
