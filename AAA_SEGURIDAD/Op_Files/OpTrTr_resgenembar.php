...
/*	        
			GROUP_CONCAT(' ', txp_contenedor) as txt_Contenedores,
*/		
   $sql = " select   txt_Consignatario as col1, txt_Naviera as col2, txp_NombBuque as col3, 
               txt_Destifinal as col4,
               txp_producto as col5, txp_Marca as col6, caj_Descripcion as col7,
               sum(txp_cantneta) as txt_SumaCant
...
$tplFile = 'OpTrTr_resgenembar.tpl';
//rs2html($rs);
$rs->MoveFirst();
$aDet =& SmartyArray($rs);
//obsafe_print_r($aDet);
