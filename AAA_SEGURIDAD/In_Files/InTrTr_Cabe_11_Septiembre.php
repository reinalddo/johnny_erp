...
//Class_Initialize Event @220-1FA6EF35
    function clsGridInTrTr_topline()
    {
        ...
        $slRestr = $_SESSION['restr'][$lsModulo]['TIP'];  //#fahJun/10/09 Restriccion de Emisor
	if (strlen($slRestr) > 1){
            if (strlen($lsRestri ) > 0 ) $this->pTipoComp->ds->SQL .= " AND  cla_tipocomp in (" . $lsRestri  . ")" ;  // #fahJun/10/09
        }
        $slAplic = "";
