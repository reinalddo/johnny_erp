...
//Class_Initialize Event @30-9CBEEBE1
    function clsRecordconcomprobantesSearch()
    {
        ...
        if($this->Visible)
        {
            ...
            $this->com_TipoComp->ds->SQL = "SELECT cla_tipoComp, cla_Descripcion  " .
"FROM genclasetran";
...
$FileName = "InTrTr_condmov.php";
$Redirect = "";
$TemplateFileName = "InTrTr_condmov.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page
...
$generated_with = "<center><font face=\"Arial\"><small>Generate by Smart NET</small></font></center>";
