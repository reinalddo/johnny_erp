...
//Class_Initialize Event @2-54C08CC9
    function clsEditableGridInTrTr_detalle() {
        ...
        $this->Garantia = CCGetFromPost("hdGarantia", "");
        $this->Recibir = CCGetFromPost("hdRecibir", "");
        $this->TipoComp = CCGetFromPost("tipoComp", "");
        if ($this->TipoComp == "") {
            $this->TipoComp = CCGetFromGet("pTipoComp", "");
        }
        $this->Emisor = CCGetFromPost("emisor", "");
        ...
        $this->det_Patio = new clsControl(ccsTextBox, "det_Patio", "Patio", ccsText, "");
        ...
        $this->btGarantia = new clsButton("btGarantia");
        $this->hdGarantia = new clsControl(ccsHidden, "hdGarantia", "hdGarantia", ccsText, "");
        $this->btRecibir = new clsButton("btRecibir");
        $this->hdRecibir = new clsControl(ccsHidden, "hdRecibir", "hdRecibir", ccsText, "");

        $this->det_SerieNew = new clsControl(ccsTextBox, "det_SerieNew", "Serie Nueva", ccsText, "");
        $this->det_SerieOld = new clsControl(ccsTextBox, "det_SerieOld", "Serie Anterior", ccsText, "");
        $this->det_WorkOrder = new clsControl(ccsTextBox, "det_WorkOrder", "Orden de Trabajo", ccsText, "");
        $this->det_Alarm = new clsControl(ccsTextBox, "det_Alarm", "Alarma", ccsText, "");
        $this->det_Tag = new clsControl(ccsTextBox, "det_Tag", "Etiqueta", ccsText, "");
    }
...
//GetFormParameters Method @2-47DD5555
    function GetFormParameters() {
        ...
        for ($RowNumber = 1; $RowNumber <= $this->TotalRows; $RowNumber++) {
            ...
            $this->FormParameters["det_SerieNew"][$RowNumber] = CCGetFromPost("det_SerieNew_" . $RowNumber);
            $this->FormParameters["det_SerieOld"][$RowNumber] = CCGetFromPost("det_SerieOld_" . $RowNumber);
            $this->FormParameters["det_WorkOrder"][$RowNumber] = CCGetFromPost("det_WorkOrder_" . $RowNumber);
            $this->FormParameters["det_Alarm"][$RowNumber] = CCGetFromPost("det_Alarm_" . $RowNumber);
            $this->FormParameters["det_Tag"][$RowNumber] = CCGetFromPost("det_Tag_" . $RowNumber);
            $this->FormParameters["det_Patio"][$RowNumber] = CCGetFromPost("det_Patio_" . $RowNumber);
...
//Validate Method @2-846815C6
    function Validate() {
        ...
        for ($RowNumber = 1; $RowNumber <= $this->TotalRows; $RowNumber++) {
            ...
            $this->det_SerieNew->SetText($this->FormParameters["det_SerieNew"][$RowNumber], $RowNumber);
            $this->det_SerieOld->SetText($this->FormParameters["det_SerieOld"][$RowNumber], $RowNumber);
            $this->det_WorkOrder->SetText($this->FormParameters["det_WorkOrder"][$RowNumber], $RowNumber);
            $this->det_Alarm->SetText($this->FormParameters["det_Alarm"][$RowNumber], $RowNumber);
            $this->det_Tag->SetText($this->FormParameters["det_Tag"][$RowNumber], $RowNumber);
            $this->det_Patio->SetText($this->FormParameters["det_Patio"][$RowNumber], $RowNumber);
...
//ValidateRow Method @2-8BCF26FA
    function ValidateRow($RowNumber) {
        ...
        $Validation = ($this->det_SerieNew->Validate() && $Validation);
        $Validation = ($this->det_SerieOld->Validate() && $Validation);
        $Validation = ($this->det_WorkOrder->Validate() && $Validation);
        $Validation = ($this->det_Alarm->Validate() && $Validation);
        $Validation = ($this->det_Tag->Validate() && $Validation);
        $Validation = ($this->det_Patio->Validate() && $Validation);
        ...
        if (!$Validation) {
            ...
            $errors .= $this->det_SerieNew->Errors->ToString();
            $errors .= $this->det_SerieOld->Errors->ToString();
            $errors .= $this->det_WokOrder->Errors->ToString();
            $errors .= $this->det_Alarm->Errors->ToString();
            $errors .= $this->det_Tag->Errors->ToString();
            $errors .= $this->det_Patio->Errors->ToString();
            ...
            $this->det_SerieNew->Errors->Clear();
            $this->det_SerieOld->Errors->Clear();
            $this->det_WorkOrder->Errors->Clear();
            $this->det_Alarm->Errors->Clear();
            $this->det_Tag->Errors->Clear();
            $this->det_Patio->Errors->Clear();
...
//CheckInsert Method @2-8C37EBF2
    function CheckInsert($RowNumber) {
        ...
        $filed = ($filed || strlen($this->FormParameters["det_Patio"][$RowNumber]));
...
//Operation Method @2-A0BDB421
    function Operation() {
        ...
        } else if (strlen(CCGetParam("btGaleria", ""))) {
            $this->PressedButton = "btGaleria";
        }
...
//      <--- fah
        ...
        $id = CCGetDBValue("select par_ID from genparametros WHERE par_Clave = 'CGRT' AND par_Valor2 =  '$this->TipoComp' AND par_Valor1 = '$this->Emisor'", $DBdatos);
    //echo "select par_ID from genparametros WHERE par_Clave = 'CGRT' AND par_Valor2 =  '$this->TipoComp' AND par_Valor1 = '$this->Emisor'"; exit;
        if ($this->Garantia == "1" && $id != "") {
            $tipoComp = CCGetDBValue("select par_Valor4 from genparametros WHERE par_Clave = 'CGRT' AND par_ID =  '$id'", $DBdatos);
            $bodega = CCGetDBValue("select par_Valor3 from genparametros WHERE par_Clave = 'CGRT' AND par_ID =  '$id'", $DBdatos);
            $this->SQL = $DBdatos->query("INSERT INTO concomprobantes 
(com_TipoComp,com_emisor,com_CodEmpresa,com_Establecimie,com_PtoEmision,com_NumComp,com_FecTrans,com_FecContab,com_FecVencim,com_CodReceptor,com_Receptor,com_Concepto,com_Valor,com_TipoCambio,com_Libro,com_NumRetenc,com_RefOperat,com_EstProceso,com_EstOperacion,com_NumProceso,com_CodMoneda,com_Usuario,com_NumPeriodo,com_PerOperativo,com_Vendedor,com_TsaImpuestos,com_FecDigita,com_Supervisor,com_Contenedor,com_NumUnit)
SELECT 
'$tipoComp',$bodega,com_CodEmpresa,com_Establecimie,com_PtoEmision,com_NumComp,com_FecTrans,com_FecContab,com_FecVencim,com_CodReceptor,com_Receptor,com_Concepto,com_Valor,com_TipoCambio,com_Libro,com_NumRetenc,com_RefOperat,com_EstProceso,com_EstOperacion,com_NumProceso,com_CodMoneda,com_Usuario,com_NumPeriodo,com_PerOperativo,com_Vendedor,com_TsaImpuestos,com_FecDigita,com_Supervisor,com_Contenedor,com_NumUnit
FROM concomprobantes WHERE com_TipoComp = '$this->TipoComp' AND  com_RegNumero = '" . CCGetFromGet("com_RegNumero", "")."'");
          
            $id = mysql_insert_id($DBdatos->link_id());
            
            $this->SQL = $DBdatos->query("insert into invenlace (enl_RegNumero, enl_RegNumero2) values ('".CCGetFromGet("com_RegNumero", "")."','$id' )");
            
            $this->SQL = $DBdatos->query("insert into invdetalle (det_RegNUmero,det_CodEmpresa,det_Secuencia,det_NumSerie,det_CodItem,det_CanDespachada,det_UniMedida,det_CantEquivale,det_CosTotal,det_ValTotal,det_DescTotal,det_RefOperativa,det_Estado,det_cosunitario,det_valunitario,det_Destino,det_Lote,det_IndiceIva,det_IndiceIce,det_SerieNew,det_SerieOld,det_WorkOrder,det_Alarm,det_Tag,det_CodAnterior,det_Patio)
                select $id ,det_CodEmpresa,det_Secuencia,det_NumSerie,det_CodItem,det_CanDespachada,det_UniMedida,det_CantEquivale,det_CosTotal,det_ValTotal,det_DescTotal,det_RefOperativa,det_Estado,det_cosunitario,det_valunitario,det_Destino,det_Lote,det_IndiceIva,det_IndiceIce,det_SerieNew,det_SerieOld,det_WorkOrder,det_Alarm,det_Tag,det_CodAnterior,det_Patio
                        from invdetalle where det_RegNUmero = '" . CCGetFromGet("com_RegNumero", "")."'");
        }
...
//InsertRow Method @2-23B3D346
    function InsertRow($RowNumber) {
        ...
        $this->ds->det_SerieNew->SetValue($this->det_SerieNew->GetValue());
        $this->ds->det_SerieOld->SetValue($this->det_SerieOld->GetValue());
        $this->ds->det_WorkOrder->SetValue($this->det_WorkOrder->GetValue());
        $this->ds->det_Alarm->SetValue($this->det_Alarm->GetValue());
        $this->ds->det_Tag->SetValue($this->det_Tag->GetValue());
        $this->ds->det_Patio->SetValue($this->det_Patio->GetValue());
...
//Show Method @2-B83D55BD
    function Show() {
        ...
        if ($this->ds->AbsolutePage < $this->ds->PageCount())
            $EmptyRowsLeft = 0;
        else {
            if ($this->ds->RecordsCount > $this->PageSize)
                $resto = fmod($this->ds->RecordsCount, $this->PageSize);
            else
                $resto = $this->ds->RecordsCount;
            $EmptyRowsLeft = $this->PageSize - $resto;
        }
        if ($EmptyRowsLeft <= 0 && $this->ds->RecordsCount == ($this->PageSize * $this->ds->AbsolutePage))
            $EmptyRowsLeft = 1;
        // end fah mod
        ...
        $existe = CCGetDBValue("SELECT count(*) AS existe FROM invenlace WHERE enl_RegNumero  =" . CCGetParam('com_RegNumero', -1), $DBdatos);
        //echo "SELECT count(*) AS existe FROM concomprobantes WHERE com_TipoComp = 'GI' AND com_RegNumero =" . CCGetParam('com_RegNumero', -1);
        ...
        if ($ilEstado < 1)
            $Tpl->SetVar('lbEstado', ' **Solo para Consulta**');
        //----------
            ...
            if ($is_next_record || ($EmptyRowsLeft && $this->InsertAllowed)) {
                do {
                    ...
                    if (!$this->FormSubmitted && $is_next_record) {
                        ...
                        $this->det_SerieNew->SetValue($this->ds->det_SerieNew->GetValue());
                        $this->det_SerieOld->SetValue($this->ds->det_SerieOld->GetValue());
                        $this->det_WorkOrder->SetValue($this->ds->det_WorkOrder->GetValue());
                        $this->det_Alarm->SetValue($this->ds->det_Alarm->GetValue());
                        $this->det_Tag->SetValue($this->ds->det_Tag->GetValue());
                        $this->det_Patio->SetValue($this->ds->det_Patio->GetValue());
                        ...
                        $this->det_SerieNew->SetText("");
                        $this->det_SerieOld->SetText("");
                        $this->det_WorkOrder->SetText("");
                        $this->det_Alarm->SetText("");
                        $this->det_Tag->SetText("");
                        $this->det_Patio->SetText("");
                    ...
                    $this->det_SerieNew->Show($RowNumber);
                    $this->det_SerieOld->Show($RowNumber);
                    $this->det_WorkOrder->Show($RowNumber);
                    $this->det_Alarm->Show($RowNumber);
                    $this->det_Tag->Show($RowNumber);
                    $this->det_Patio->Show($RowNumber);
        ...
        if($this->Emisor == ''){
              $numReg = CCGetFromGet("com_RegNumero", "");
              $this->Emisor = CCGetDBValue("SELECT com_Emisor
FROM concomprobantes WHERE com_RegNumero = '$numReg'", $DBdatos);
        }
        $id = CCGetDBValue("select par_ID from genparametros WHERE par_Clave = 'CGRT' AND par_Valor2 =  '$this->TipoComp' AND par_Valor1 = '$this->Emisor'", $DBdatos);
        
        //$tipoComp = CCGetDBValue("select par_Valor2 from genparametros WHERE par_Clave = 'CGRT' AND par_Valor2 = '$this->TipoComp'", $DBdatos);
        //echo $existe." - ".$tipoComp."select par_Valor2 from genparametros WHERE par_Clave = 'CGRT' AND par_Valor2 = '$this->TipoComp'";
        //echo "select par_ID from genparametros WHERE par_Clave = 'CGRT' AND par_Valor2 =  '$this->TipoComp' AND par_Valor1 = '$this->Emisor'";
        
        if ($existe < 1 && $id != "") {
            $this->btGarantia->Show();
        }
...
//Class_Initialize Event @2-0F8D9C7B
    function clsInTrTr_detalleDataSource() {
        ...
        $this->det_SerieNew = new clsField("det_SerieNew", ccsText, "");
        $this->det_SerieOld = new clsField("det_SerieOld", ccsText, "");
        $this->det_WorkOrder = new clsField("det_WorkOrder", ccsText, "");
        $this->det_Alarm = new clsField("det_Alarm", ccsText, "");
        $this->det_Tag = new clsField("det_Tag", ccsText, "");
        $this->det_Patio = new clsField("det_Patio", ccsText, "");
...
//SetOrder Method @2-F2BE1C38
    function SetOrder($SorterName, $SorterDirection) {
        ...
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, array("Sorter_det_Secuencia" => array("det_Secuencia", ""),
...
//Open Method @2-B4A291E1
    function Open() {
        ...
        $this->SQL = "SELECT com_RegNumero, com_NumPeriodo, invdetalle.*,  det_cosunitario AS det_CosUnitario,
                ...
                "       tab_multiplicador, tab_divisor, det_CodAnterior as act_codanterior, det_NumSerie, det_Patio " .
...
//SetValues Method @2-4F293BAD
    function SetValues() {
        ...
        $this->det_SerieNew->SetDBValue($this->f("det_SerieNew"));
        $this->det_SerieOld->SetDBValue($this->f("det_SerieOld"));
        $this->det_WorkOrder->SetDBValue($this->f("det_WorkOrder"));
        $this->det_Alarm->SetDBValue($this->f("det_Alarm"));
        $this->det_Tag->SetDBValue($this->f("det_Tag"));
        $this->det_Patio->SetDBValue($this->f("det_Patio"));
...
//Insert Method @2-756EEC02
    function Insert() {
        global $DBdatos;
        $val = CCGetDBValue("select par_valor2 from genparametros WHERE par_Clave = 'ITARI' AND par_Valor1 =  '".$this->det_CodItem->GetValue()."'", $DBdatos);
        if($val == ""){
            $val = 0;
        }
        $this->det_CosUnitario->setValue($val); 
        $this->det_CosTotal->setValue($this->det_CantEquivale->GetValue()*$val);
        ...
        $this->cp["det_SerieNew"] = new clsSQLParameter("ctrldet_SerieNew", ccsText, "", "", $this->det_SerieNew->GetValue(), 0, false, $this->ErrorBlock);
        $this->cp["det_SerieOld"] = new clsSQLParameter("ctrldet_SerieOld", ccsText, "", "", $this->det_SerieOld->GetValue(), 0, false, $this->ErrorBlock);
        $this->cp["det_WorkOrder"] = new clsSQLParameter("ctrldet_WorkOrder", ccsText, "", "", $this->det_WorkOrder->GetValue(), 0, false, $this->ErrorBlock);
        $this->cp["det_Alarm"] = new clsSQLParameter("ctrldet_Alarm", ccsText, "", "", $this->det_Alarm->GetValue(), 0, false, $this->ErrorBlock);
        $this->cp["det_Tag"] = new clsSQLParameter("ctrldet_Tag", ccsText, "", "", $this->det_Tag->GetValue(), 0, false, $this->ErrorBlock);
        $this->cp["det_Patio"] = new clsSQLParameter("ctrldet_Patio", ccsText, "", "", $this->det_Patio->GetValue(), 0, false, $this->ErrorBlock);
        ...
        $this->SQL = "INSERT INTO invdetalle ("
                ...
                . $this->ToSQL($this->cp["det_SerieNew"]->GetDBValue(), $this->cp["det_SerieNew"]->DataType) . ", "
                . $this->ToSQL($this->cp["det_SerieOld"]->GetDBValue(), $this->cp["det_SerieOld"]->DataType) . ", "
                . $this->ToSQL($this->cp["det_WorkOrder"]->GetDBValue(), $this->cp["det_WorkOrder"]->DataType) . ", "
                . $this->ToSQL($this->cp["det_Alarm"]->GetDBValue(), $this->cp["det_Alarm"]->DataType) . ", "
                . $this->ToSQL($this->cp["det_Tag"]->GetDBValue(), $this->cp["det_Tag"]->DataType) . ", "
                . $this->ToSQL($this->cp["det_Patio"]->GetDBValue(), $this->cp["det_Patio"]->DataType)
                . ")";
...
//Update Method @2-6DC39C2E
    function Update() {
        ...
        $this->cp["det_SerieNew"] = new clsSQLParameter("det_SerieNew", ccsText, "", "", $this->det_SerieNew->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["det_SerieOld"] = new clsSQLParameter("det_SerieOld", ccsText, "", "", $this->det_SerieOld->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["det_WorkOrder"] = new clsSQLParameter("det_WorkOrder", ccsText, "", "", $this->det_WorkOrder->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["det_Alarm"] = new clsSQLParameter("det_Alarm", ccsText, "", "", $this->det_Alarm->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["det_Tag"] = new clsSQLParameter("det_Tag", ccsText, "", "", $this->det_Tag->GetValue(), "", false, $this->ErrorBlock);
        $this->cp["det_Patio"] = new clsSQLParameter("det_Patio", ccsText, "", "", $this->det_Patio->GetValue(), "", false, $this->ErrorBlock);
        ...
        $this->SQL = "UPDATE invdetalle SET "
                ...
                . "det_SerieNew=" . $this->ToSQL($this->cp["det_SerieNew"]->GetDBValue(), $this->cp["det_SerieNew"]->DataType) . ", "
                . "det_SerieOld=" . $this->ToSQL($this->cp["det_SerieOld"]->GetDBValue(), $this->cp["det_SerieOld"]->DataType) . ", "
                . "det_WorkOrder=" . $this->ToSQL($this->cp["det_WorkOrder"]->GetDBValue(), $this->cp["det_WorkOrder"]->DataType) . ", "
                . "det_Alarm=" . $this->ToSQL($this->cp["det_Alarm"]->GetDBValue(), $this->cp["det_Alarm"]->DataType) . ", "
                . "det_Tag=" . $this->ToSQL($this->cp["det_Tag"]->GetDBValue(), $this->cp["det_Tag"]->DataType) . ", "
                . "det_Patio=" . $this->ToSQL($this->cp["det_Patio"]->GetDBValue(), $this->cp["det_Patio"]->DataType) . ", "
...
$FileName = "InTrTr_deta05.php";
$Redirect = "";
$TemplateFileName = "InTrTr_deta05.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page
