 ...
 *	@rev	fah	10/03/10 Incluir variable SSC (sufijo Subccategoria) para patrones de contabilizacion en cascada: Subcategoria + grupo de item
  *	@rev	fah	21/07/10 Mejorar el filtrado inicial de comprobantes cuando se procesa periodos, para incluir solo los contabilizables
*	@rev	fah	28/07/10	Excluir los items no inventariables de la contabilizacion
*	@rev	fah	07/09/10	Actualizar status de comprobante al contabilizar (=5)
 **/
